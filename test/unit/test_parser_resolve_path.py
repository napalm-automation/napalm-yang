    ...
    def test_ios_ip_addresses(self):
        data = {
            "ip": {
                "address": {
                    "192.168.2.1": {
                        "255.255.255.0": {"secondary": {"#standalone": True}}
                    },
                    "192.168.1.1": {"255.255.255.0": {"#standalone": True}},
                    "172.20.0.1": {
                        "255.255.255.0": {"secondary": {"#standalone": True}}
                    },
                }
        ...
        expected = [
            ...
            {"#standalone": True, "mask": "255.255.255.0", "prefix": "192.168.1.1"},
            {
                "mask": "255.255.255.0",
                "prefix": "192.168.2.1",
                "secondary": {"#standalone": True},
