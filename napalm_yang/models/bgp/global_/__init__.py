...
class global_(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__config','__state','__default_route_distance','__confederation','__graceful_restart','__use_multiple_paths','__route_selection_options','__afi_safis','__apply_policy',)
...
depending on the context.
  ...
  _pyangbind_elements = {'config': config, 'state': state, 'default_route_distance': default_route_distance, 'confederation': confederation, 'graceful_restart': graceful_restart, 'use_multiple_paths': use_multiple_paths, 'route_selection_options': route_selection_options, 'afi_safis': afi_safis, 'apply_policy': apply_policy, }
