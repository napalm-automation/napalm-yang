...
policy forwarding rule binding.
  """
    __slots__ = (
        "_path_helper", "_extmethods", "__interface_id", "__apply_forwarding_policy"
    )
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.__apply_forwarding_policy = YANGDynClass(
            base=six.text_type,
            is_leaf=True,
            yang_name="apply-forwarding-policy",
            parent=self,
            path_helper=self._path_helper,
            extmethods=self._extmethods,
            register_paths=True,
...
referenced by the corresponding interface.
    ...
    apply_forwarding_policy = __builtin__.property(
        _get_apply_forwarding_policy, _set_apply_forwarding_policy
    )

    _pyangbind_elements = OrderedDict(
        [
            ("interface_id", interface_id),
            ("apply_forwarding_policy", apply_forwarding_policy),
        ]
    )
