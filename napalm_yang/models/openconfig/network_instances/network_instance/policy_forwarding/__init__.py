...
a network instance.
  """
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.__path_selection_groups = YANGDynClass(
            base=path_selection_groups.path_selection_groups,
            is_container="container",
            yang_name="path-selection-groups",
            parent=self,
            path_helper=self._path_helper,
            extmethods=self._extmethods,
            register_paths=True,
...
within the policy forwarding model.
    ...
    path_selection_groups = __builtin__.property(
        _get_path_selection_groups, _set_path_selection_groups
    )
    ...
    _pyangbind_elements = OrderedDict(
        [
            ...
            ("path_selection_groups", path_selection_groups),
        ]
    )
