...
all configuration and state parameters are common
  """
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.__connection_point_id = YANGDynClass(
            base=six.text_type,
            is_leaf=True,
            yang_name="connection-point-id",
            parent=self,
...
connection point
    ...
    connection_point_id = __builtin__.property(
        _get_connection_point_id, _set_connection_point_id
    )
