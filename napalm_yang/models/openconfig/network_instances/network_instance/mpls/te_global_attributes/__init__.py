...
class te_global_attributes(PybindBase):
  ...
  """
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.__mpls_admin_groups = YANGDynClass(
            base=mpls_admin_groups.mpls_admin_groups,
            is_container="container",
            yang_name="mpls-admin-groups",
            parent=self,
            path_helper=self._path_helper,
            extmethods=self._extmethods,
            register_paths=True,
        ...
        self.__te_lsp_timers = YANGDynClass(
            base=te_lsp_timers.te_lsp_timers,
            is_container="container",
            yang_name="te-lsp-timers",
            parent=self,
            path_helper=self._path_helper,
            extmethods=self._extmethods,
            register_paths=True,
...
and cleanup of TE LSPs
    ...
    mpls_admin_groups = __builtin__.property(
        _get_mpls_admin_groups, _set_mpls_admin_groups
    )
    ...
    _pyangbind_elements = OrderedDict(
        [
            ("srlgs", srlgs),
            ("mpls_admin_groups", mpls_admin_groups),
            ("te_lsp_timers", te_lsp_timers),
        ]
    )
