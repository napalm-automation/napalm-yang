...
entropy label supportmay be added here
  """
    __slots__ = (
        ...
        "__config",
        "__state",
        "__interface_attributes",
        "__reserved_label_blocks",
    )
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.__interface_attributes = YANGDynClass(
            base=interface_attributes.interface_attributes,
            is_container="container",
            yang_name="interface-attributes",
            parent=self,
            path_helper=self._path_helper,
            extmethods=self._extmethods,
            register_paths=True,
        ...
        self.__reserved_label_blocks = YANGDynClass(
            base=reserved_label_blocks.reserved_label_blocks,
            is_container="container",
            yang_name="reserved-label-blocks",
            parent=self,
            path_helper=self._path_helper,
            extmethods=self._extmethods,
            register_paths=True,
...
allocation of labels should be out of the label block specified.
    ...
    interface_attributes = __builtin__.property(
        _get_interface_attributes, _set_interface_attributes
    )
    reserved_label_blocks = __builtin__.property(
        _get_reserved_label_blocks, _set_reserved_label_blocks
    )
    ...
    _pyangbind_elements = OrderedDict(
        [
            ...
            ("reserved_label_blocks", reserved_label_blocks),
        ]
    )
