...
allocation of labels should be out of the label block specified.
  """
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.__reserved_label_block = YANGDynClass(
            base=YANGListType(
                "local_id",
                reserved_label_block.reserved_label_block,
                yang_name="reserved-label-block",
                parent=self,
                is_container="list",
                user_ordered=False,
...
the end label that should be allocated for use by a specific protocol.
    ...
    reserved_label_block = __builtin__.property(
        _get_reserved_label_block, _set_reserved_label_block
    )
