...
auto-bandwidth on the tunnel.
  """
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.__adjust_interval = YANGDynClass(
            base=RestrictedClassType(
                base_type=long,
        ...
        self.__adjust_threshold = YANGDynClass(
            base=RestrictedClassType(
...
triggered
    ...
    adjust_threshold = __builtin__.property(
        _get_adjust_threshold, _set_adjust_threshold
    )
