...
class p2p_primary_path(PybindBase):
  ...
  """
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.__candidate_secondary_paths = YANGDynClass(
            base=candidate_secondary_paths.candidate_secondary_paths,
            is_container="container",
            yang_name="candidate-secondary-paths",
            parent=self,
            path_helper=self._path_helper,
            extmethods=self._extmethods,
            register_paths=True,
...
link affinities
    ...
    candidate_secondary_paths = __builtin__.property(
        _get_candidate_secondary_paths, _set_candidate_secondary_paths
    )
    ...
    _pyangbind_elements = OrderedDict(
        [
            ...
            ("config", config),
            ("state", state),
            ("candidate_secondary_paths", candidate_secondary_paths),
