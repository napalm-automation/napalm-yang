...
class named_explicit_paths(PybindBase):
  ...
  """
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.__named_explicit_path = YANGDynClass(
            base=YANGListType(
                "name",
                named_explicit_path.named_explicit_path,
                yang_name="named-explicit-path",
                parent=self,
                is_container="list",
                user_ordered=False,
    ...
    named_explicit_path = __builtin__.property(
        _get_named_explicit_path, _set_named_explicit_path
    )
