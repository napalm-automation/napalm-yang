...
class state(PybindBase):
  ...
  """
  __slots__ = ('_path_helper', '_extmethods', '__name','__path_computation_method','__use_cspf','__cspf_tiebreaker','__path_computation_server','__explicit_path_name','__preference','__setup_priority','__hold_priority','__retry_timer','__associated_rsvp_session',)
