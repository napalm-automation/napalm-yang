...
class state(PybindBase):
  ...
  """
    __slots__ = (
        ...
        "_extmethods",
        "__name",
        "__path_computation_method",
        "__use_cspf",
        "__cspf_tiebreaker",
        "__path_computation_server",
        "__explicit_path_name",
        "__preference",
        "__setup_priority",
        "__hold_priority",
        "__retry_timer",
        "__associated_rsvp_session",
    )
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.__path_computation_method = YANGDynClass(
            base=RestrictedClassType(
                ...
                restriction_arg={
                    ...
                    "oc-mpls-types:LOCALLY_COMPUTED": {
                        "@module": "openconfig-mpls-types",
                        "@namespace": "http://openconfig.net/yang/mpls-types",
                    },
                    "oc-mplst:LOCALLY_COMPUTED": {
                        "@module": "openconfig-mpls-types",
                        "@namespace": "http://openconfig.net/yang/mpls-types",
                    },
                    "oc-mpls-t:LOCALLY_COMPUTED": {
                        "@module": "openconfig-mpls-types",
                        "@namespace": "http://openconfig.net/yang/mpls-types",
                    },
                    "EXTERNALLY_QUERIED": {
                    ...
                    "oc-mpls-types:EXTERNALLY_QUERIED": {
                        "@module": "openconfig-mpls-types",
                        "@namespace": "http://openconfig.net/yang/mpls-types",
                    },
                    "oc-mplst:EXTERNALLY_QUERIED": {
                        "@module": "openconfig-mpls-types",
                        "@namespace": "http://openconfig.net/yang/mpls-types",
                    },
                    "oc-mpls-t:EXTERNALLY_QUERIED": {
                        "@module": "openconfig-mpls-types",
                        "@namespace": "http://openconfig.net/yang/mpls-types",
                    },
                    "EXPLICITLY_DEFINED": {
                    ...
                    "oc-mpls-types:EXPLICITLY_DEFINED": {
                        "@module": "openconfig-mpls-types",
                        "@namespace": "http://openconfig.net/yang/mpls-types",
                    },
                    "oc-mplst:EXPLICITLY_DEFINED": {
                        "@module": "openconfig-mpls-types",
                        "@namespace": "http://openconfig.net/yang/mpls-types",
                    },
                    "oc-mpls-t:EXPLICITLY_DEFINED": {
                        "@module": "openconfig-mpls-types",
                        "@namespace": "http://openconfig.net/yang/mpls-types",
                    },
                },
            ),
            default=six.text_type("oc-mplst:LOCALLY_COMPUTED"),
            is_leaf=True,
            yang_name="path-computation-method",
            parent=self,
            path_helper=self._path_helper,
            extmethods=self._extmethods,
            register_paths=True,
        ...
        self.__cspf_tiebreaker = YANGDynClass(
            base=RestrictedClassType(
                base_type=six.text_type,
                restriction_type="dict_key",
                restriction_arg={"RANDOM": {}, "LEAST_FILL": {}, "MOST_FILL": {}},
            ),
            default=six.text_type("RANDOM"),
            is_leaf=True,
            yang_name="cspf-tiebreaker",
            parent=self,
            path_helper=self._path_helper,
            extmethods=self._extmethods,
            register_paths=True,
            namespace="http://openconfig.net/yang/network-instance",
            defining_module="openconfig-network-instance",
            yang_type="cspf-tie-breaking",
            is_config=False,
        )
        self.__path_computation_server = YANGDynClass(
            base=[
                RestrictedClassType(
                    base_type=six.text_type,
                    restriction_dict={
            ...
            is_leaf=True,
            yang_name="path-computation-server",
            parent=self,
            path_helper=self._path_helper,
            extmethods=self._extmethods,
            register_paths=True,
        ...
        self.__explicit_path_name = YANGDynClass(
            base=six.text_type,
            is_leaf=True,
            yang_name="explicit-path-name",
            parent=self,
            path_helper=self._path_helper,
            extmethods=self._extmethods,
            register_paths=True,
        ...
        self.__retry_timer = YANGDynClass(
            base=RestrictedClassType(
                base_type=RestrictedClassType(
                    base_type=int, restriction_dict={"range": ["0..65535"]}, int_size=16
                ),
                restriction_dict={"range": ["1..600"]},
            ),
            is_leaf=True,
            yang_name="retry-timer",
            parent=self,
            path_helper=self._path_helper,
            extmethods=self._extmethods,
            register_paths=True,
        ...
        self.__associated_rsvp_session = YANGDynClass(
            base=six.text_type,
            is_leaf=True,
            yang_name="associated-rsvp-session",
            parent=self,
            path_helper=self._path_helper,
            extmethods=self._extmethods,
            register_paths=True,
...
that details of the signaling can be retrieved.
            ...
            raise ValueError(
                {
                    ...
                    "defined-type": "leafref",
                    "generated-type": """YANGDynClass(base=six.text_type, is_leaf=True, yang_name="associated-rsvp-session", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/network-instance', defining_module='openconfig-network-instance', yang_type='leafref', is_config=False)""",
                }
            )
    ...
    _pyangbind_elements = OrderedDict(
        [
            ("name", name),
            ("path_computation_method", path_computation_method),
            ("use_cspf", use_cspf),
            ("cspf_tiebreaker", cspf_tiebreaker),
            ("path_computation_server", path_computation_server),
            ("explicit_path_name", explicit_path_name),
            ("preference", preference),
            ("setup_priority", setup_priority),
            ("hold_priority", hold_priority),
            ("retry_timer", retry_timer),
            ("associated_rsvp_session", associated_rsvp_session),
        ]
    )
