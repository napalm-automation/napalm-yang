  ...
  """
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.__p2p_primary_path = YANGDynClass(
            base=p2p_primary_path.p2p_primary_path,
            is_container="container",
        ...
        self.__p2p_secondary_paths = YANGDynClass(
            base=p2p_secondary_paths.p2p_secondary_paths,
            is_container="container",
            yang_name="p2p-secondary-paths",
            parent=self,
            path_helper=self._path_helper,
            extmethods=self._extmethods,
            register_paths=True,
    ...
    p2p_secondary_paths = __builtin__.property(
        _get_p2p_secondary_paths, _set_p2p_secondary_paths
    )
    ...
    _pyangbind_elements = OrderedDict(
        [
            ("config", config),
            ("state", state),
            ("p2p_primary_path", p2p_primary_path),
            ("p2p_secondary_paths", p2p_secondary_paths),
        ]
    )
