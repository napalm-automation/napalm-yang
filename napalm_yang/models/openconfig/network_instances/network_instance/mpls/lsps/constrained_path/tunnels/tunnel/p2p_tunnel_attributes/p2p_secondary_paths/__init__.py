...
class p2p_secondary_paths(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__p2p_secondary_path = None
  ...
  def _initialized_p2p_secondary_path(self):
    return self.__p2p_secondary_path is not None
  ...
  def _get_p2p_secondary_path(self):
    ...
    """
    if self.__p2p_secondary_path is None:
