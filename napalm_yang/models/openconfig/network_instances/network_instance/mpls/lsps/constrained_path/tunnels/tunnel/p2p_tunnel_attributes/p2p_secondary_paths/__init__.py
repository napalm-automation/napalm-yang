...
class p2p_secondary_paths(PybindBase):
  ...
  """
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.__p2p_secondary_path = YANGDynClass(
            base=YANGListType(
                "name",
                p2p_secondary_path.p2p_secondary_path,
                yang_name="p2p-secondary-path",
                parent=self,
                is_container="list",
                user_ordered=False,
    ...
    p2p_secondary_path = __builtin__.property(
        _get_p2p_secondary_path, _set_p2p_secondary_path
    )
