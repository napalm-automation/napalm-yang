...
adjustment
  """
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.__overflow_threshold = YANGDynClass(
...
events needed to trigger an overflow adjustment
    ...
    overflow_threshold = __builtin__.property(
        _get_overflow_threshold, _set_overflow_threshold
    )
    trigger_event_count = __builtin__.property(
        _get_trigger_event_count, _set_trigger_event_count
    )
