...
tunnels:
  """
    __slots__ = (
        "_path_helper", "_extmethods", "__specification_type", "__set_bandwidth"
    )
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.__specification_type = YANGDynClass(
            base=RestrictedClassType(
                ...
                restriction_arg={"SPECIFIED": {}, "AUTO": {}},
            ),
...
offline calculation
    ...
    specification_type = __builtin__.property(
        _get_specification_type, _set_specification_type
    )
    set_bandwidth = __builtin__.property(_get_set_bandwidth, _set_set_bandwidth)

    _pyangbind_elements = OrderedDict(
        [("specification_type", specification_type), ("set_bandwidth", set_bandwidth)]
    )
