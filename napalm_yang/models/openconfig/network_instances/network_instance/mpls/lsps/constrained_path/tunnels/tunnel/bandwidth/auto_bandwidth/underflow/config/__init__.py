...
adjustment
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__trigger_event_count = None
    self.__enabled = None
    self.__underflow_threshold = None
...
adjustment on the lsp
  ...
  def _initialized_underflow_threshold(self):
    return self.__underflow_threshold is not None
...
and underflow event
    """
    if self.__underflow_threshold is None:
...
and underflow event
  ...
  def _initialized_trigger_event_count(self):
    return self.__trigger_event_count is not None
...
events needed to trigger an underflow adjustment
    """
    if self.__trigger_event_count is None:
