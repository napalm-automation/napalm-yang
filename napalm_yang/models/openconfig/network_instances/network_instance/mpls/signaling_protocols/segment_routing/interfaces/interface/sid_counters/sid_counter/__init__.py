...
class sid_counter(PybindBase):
  ...
  """
    __slots__ = (
        "_path_helper", "_extmethods", "__mpls_label", "__state", "__forwarding_classes"
    )
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.__forwarding_classes = YANGDynClass(
            base=forwarding_classes.forwarding_classes,
            is_container="container",
            yang_name="forwarding-classes",
            parent=self,
            path_helper=self._path_helper,
            extmethods=self._extmethods,
            register_paths=True,
