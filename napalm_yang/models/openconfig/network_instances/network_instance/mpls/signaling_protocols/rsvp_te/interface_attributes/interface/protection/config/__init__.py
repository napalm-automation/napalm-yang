...
class config(PybindBase):
  ...
  """
    __slots__ = (
        "_path_helper",
        "_extmethods",
        "__link_protection_style_requested",
        "__bypass_optimize_interval",
    )
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.__link_protection_style_requested = YANGDynClass(
            ...
            default=six.text_type("oc-mplst:LINK_NODE_PROTECTION_REQUESTED"),
            is_leaf=True,
            yang_name="link-protection-style-requested",
            parent=self,
        ...
        self.__bypass_optimize_interval = YANGDynClass(
            base=RestrictedClassType(
                base_type=int, restriction_dict={"range": ["0..65535"]}, int_size=16
            ),
            is_leaf=True,
            yang_name="bypass-optimize-interval",
            parent=self,
            path_helper=self._path_helper,
            extmethods=self._extmethods,
            register_paths=True,
...
of the bypass LSPs
    ...
    link_protection_style_requested = __builtin__.property(
        _get_link_protection_style_requested, _set_link_protection_style_requested
    )
    bypass_optimize_interval = __builtin__.property(
        _get_bypass_optimize_interval, _set_bypass_optimize_interval
    )

    _pyangbind_elements = OrderedDict(
        [
            ("link_protection_style_requested", link_protection_style_requested),
            ("bypass_optimize_interval", bypass_optimize_interval),
        ]
    )
