...
class bandwidth_reservations(PybindBase):
  ...
  """
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.__bandwidth_reservation = YANGDynClass(
            base=YANGListType(
                "priority",
                bandwidth_reservation.bandwidth_reservation,
                yang_name="bandwidth-reservation",
                parent=self,
                is_container="list",
                user_ordered=False,
...
the interface.
    ...
    bandwidth_reservation = __builtin__.property(
        _get_bandwidth_reservation, _set_bandwidth_reservation
    )
