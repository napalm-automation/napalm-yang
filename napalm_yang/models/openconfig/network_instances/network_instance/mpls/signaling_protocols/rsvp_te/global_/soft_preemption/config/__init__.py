...
soft preemption support
  """
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.__soft_preemption_timeout = YANGDynClass(
            ...
            is_leaf=True,
            yang_name="soft-preemption-timeout",
            parent=self,
            path_helper=self._path_helper,
            extmethods=self._extmethods,
            register_paths=True,
...
the local system reverts to hard pre-emption.
    ...
    soft_preemption_timeout = __builtin__.property(
        _get_soft_preemption_timeout, _set_soft_preemption_timeout
    )

    _pyangbind_elements = OrderedDict(
        [("enable", enable), ("soft_preemption_timeout", soft_preemption_timeout)]
    )
