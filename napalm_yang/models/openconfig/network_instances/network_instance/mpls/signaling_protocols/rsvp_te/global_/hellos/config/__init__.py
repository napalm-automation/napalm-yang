...
hellos
  """
    __slots__ = (
        "_path_helper", "_extmethods", "__hello_interval", "__refresh_reduction"
    )
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.__hello_interval = YANGDynClass(
            base=RestrictedClassType(
                ...
                restriction_dict={"range": ["1000..60000"]},
            ),
...
and summary refresh
    ...
    refresh_reduction = __builtin__.property(
        _get_refresh_reduction, _set_refresh_reduction
    )

    _pyangbind_elements = OrderedDict(
        [("hello_interval", hello_interval), ("refresh_reduction", refresh_reduction)]
    )
