    ...
    def __init__(self, *args, **kwargs):
        ...
        self.__authentication_key = YANGDynClass(
            base=RestrictedClassType(
                base_type=six.text_type, restriction_dict={"length": ["1..32"]}
            ),
            is_leaf=True,
...
messages
    ...
    authentication_key = __builtin__.property(
        _get_authentication_key, _set_authentication_key
    )

    _pyangbind_elements = OrderedDict(
        [("enable", enable), ("authentication_key", authentication_key)]
    )
