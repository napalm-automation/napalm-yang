...
class session(PybindBase):
  ...
  """
  __slots__ = ('_path_helper', '_extmethods', '__local_index','__record_route_objects','__state',)
...
RSVP session
  ...
  _pyangbind_elements = OrderedDict([('local_index', local_index), ('record_route_objects', record_route_objects), ('state', state), ])
