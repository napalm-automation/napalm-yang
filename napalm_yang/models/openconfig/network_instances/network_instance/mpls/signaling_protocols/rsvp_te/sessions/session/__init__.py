...
class session(PybindBase):
  ...
  """
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.__record_route_objects = YANGDynClass(
            base=record_route_objects.record_route_objects,
            is_container="container",
            yang_name="record-route-objects",
            parent=self,
            path_helper=self._path_helper,
            extmethods=self._extmethods,
            register_paths=True,
...
RSVP session
    ...
    _pyangbind_elements = OrderedDict(
        [
            ...
            ("record_route_objects", record_route_objects),
            ("state", state),
        ]
    )
