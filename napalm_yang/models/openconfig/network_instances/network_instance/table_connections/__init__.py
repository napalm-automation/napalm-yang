...
between tables
  """
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.__table_connection = YANGDynClass(
            base=YANGListType(
                "src_protocol dst_protocol address_family",
                table_connection.table_connection,
                yang_name="table-connection",
                parent=self,
                is_container="list",
                user_ordered=False,
                path_helper=self._path_helper,
                yang_keys="src-protocol dst-protocol address-family",
                extensions=None,
            ),
            is_container="list",
            yang_name="table-connection",
...
protocol to advertise, or match within its policies.
    ...
    table_connection = __builtin__.property(
        _get_table_connection, _set_table_connection
    )
