...
with a peer or group
    ...
    remove_private_as = __builtin__.property(
        _get_remove_private_as, _set_remove_private_as
    )
    route_flap_damping = __builtin__.property(
        _get_route_flap_damping, _set_route_flap_damping
    )
