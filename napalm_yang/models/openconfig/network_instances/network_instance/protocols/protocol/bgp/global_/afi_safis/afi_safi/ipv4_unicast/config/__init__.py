...
AFI-SAFI options
  """
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.__send_default_route = YANGDynClass(
            base=YANGBool,
            default=YANGBool("false"),
            is_leaf=True,
            yang_name="send-default-route",
            parent=self,
    ...
    send_default_route = __builtin__.property(
        _get_send_default_route, _set_send_default_route
    )
