...
which the metric to the next-hop is lowest
    ...
    always_compare_med = __builtin__.property(
        _get_always_compare_med, _set_always_compare_med
    )
    ignore_as_path_length = __builtin__.property(
        _get_ignore_as_path_length, _set_ignore_as_path_length
    )
    external_compare_router_id = __builtin__.property(
        _get_external_compare_router_id, _set_external_compare_router_id
    )
    advertise_inactive_routes = __builtin__.property(
        _get_advertise_inactive_routes, _set_advertise_inactive_routes
    )
    enable_aigp = __builtin__.property(_get_enable_aigp, _set_enable_aigp)
    ignore_next_hop_igp_metric = __builtin__.property(
        _get_ignore_next_hop_igp_metric, _set_ignore_next_hop_igp_metric
    )
