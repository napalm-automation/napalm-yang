...
class bgp(PybindBase):
  ...
  """
    __slots__ = (
        "_path_helper", "_extmethods", "__global_", "__neighbors", "__peer_groups"
    )
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.__peer_groups = YANGDynClass(
            base=peer_groups.peer_groups,
            is_container="container",
            yang_name="peer-groups",
            parent=self,
            path_helper=self._path_helper,
            extmethods=self._extmethods,
            register_paths=True,
    ...
    _pyangbind_elements = OrderedDict(
        [("global_", global_), ("neighbors", neighbors), ("peer_groups", peer_groups)]
    )
