...
class bgp(PybindBase):
  ...
  """
  __slots__ = ('_path_helper', '_extmethods', '__global_','__neighbors','__peer_groups',)
  ...
  _pyangbind_elements = OrderedDict([('global_', global_), ('neighbors', neighbors), ('peer_groups', peer_groups), ])
