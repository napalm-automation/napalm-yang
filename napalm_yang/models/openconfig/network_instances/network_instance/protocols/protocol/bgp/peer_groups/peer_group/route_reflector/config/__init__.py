...
id to be set for each neighbor.
    ...
    route_reflector_cluster_id = __builtin__.property(
        _get_route_reflector_cluster_id, _set_route_reflector_cluster_id
    )
    route_reflector_client = __builtin__.property(
        _get_route_reflector_client, _set_route_reflector_client
    )
