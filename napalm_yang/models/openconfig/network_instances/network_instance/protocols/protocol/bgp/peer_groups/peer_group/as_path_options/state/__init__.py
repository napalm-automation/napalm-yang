...
mechanisms for the BGP peer or group
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__allow_own_as','__replace_peer_as','__disable_peer_as_filter',)
...
their AS number is in the AS path of the route.
  ...
  _pyangbind_elements = {'allow_own_as': allow_own_as, 'replace_peer_as': replace_peer_as, 'disable_peer_as_filter': disable_peer_as_filter, }
