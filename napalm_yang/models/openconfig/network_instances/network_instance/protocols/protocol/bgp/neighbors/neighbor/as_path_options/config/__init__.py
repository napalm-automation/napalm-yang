...
for the BGP peer or group
  """
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.__allow_own_as = YANGDynClass(
        ...
        self.__replace_peer_as = YANGDynClass(
            base=YANGBool,
            default=YANGBool("false"),
            is_leaf=True,
            yang_name="replace-peer-as",
            parent=self,
            path_helper=self._path_helper,
            extmethods=self._extmethods,
            register_paths=True,
...
with the local autonomous system number
    ...
    _pyangbind_elements = OrderedDict(
        [("allow_own_as", allow_own_as), ("replace_peer_as", replace_peer_as)]
    )
