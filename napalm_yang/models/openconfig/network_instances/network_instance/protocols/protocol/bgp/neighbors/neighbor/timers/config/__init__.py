...
particular set of NLRI exhibit instability.
    ...
    keepalive_interval = __builtin__.property(
        _get_keepalive_interval, _set_keepalive_interval
    )
    minimum_advertisement_interval = __builtin__.property(
        _get_minimum_advertisement_interval, _set_minimum_advertisement_interval
    )
