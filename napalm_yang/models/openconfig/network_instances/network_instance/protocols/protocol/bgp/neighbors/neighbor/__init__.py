...
uniquely identified by peer IPv[46] address
  """
  __slots__ = ('_path_helper', '_extmethods', '__neighbor_address','__config','__state','__timers','__transport','__error_handling','__graceful_restart','__logging_options','__ebgp_multihop','__route_reflector','__as_path_options','__add_paths','__use_multiple_paths','__apply_policy','__afi_safis',)
