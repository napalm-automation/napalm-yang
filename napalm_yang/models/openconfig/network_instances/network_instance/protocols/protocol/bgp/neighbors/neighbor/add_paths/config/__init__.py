...
restrict the prefixes for which add-paths is enabled
    ...
    eligible_prefix_policy = __builtin__.property(
        _get_eligible_prefix_policy, _set_eligible_prefix_policy
    )
    ...
    _pyangbind_elements = OrderedDict(
        [
            ("receive", receive),
            ("send_max", send_max),
            ("eligible_prefix_policy", eligible_prefix_policy),
        ]
    )
