...
class state(PybindBase):
  ...
  """
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.__peer_restart_time = YANGDynClass(
            base=RestrictedClassType(
                base_type=RestrictedClassType(
                    base_type=int, restriction_dict={"range": ["0..65535"]}, int_size=16
                ),
        ...
        self.__local_restarting = YANGDynClass(
            base=YANGBool,
            is_leaf=True,
            yang_name="local-restarting",
            parent=self,
            path_helper=self._path_helper,
            extmethods=self._extmethods,
            register_paths=True,
        ...
        self.__mode = YANGDynClass(
            base=RestrictedClassType(
                ...
                restriction_arg={
                    "HELPER_ONLY": {}, "BILATERAL": {}, "REMOTE_HELPER": {}
                },
            ),
            is_leaf=True,
            yang_name="mode",
...
restart with the peer
    ...
    _pyangbind_elements = OrderedDict(
        [
            ...
            ("peer_restart_time", peer_restart_time),
            ("peer_restarting", peer_restarting),
            ("local_restarting", local_restarting),
            ("mode", mode),
        ]
    )
