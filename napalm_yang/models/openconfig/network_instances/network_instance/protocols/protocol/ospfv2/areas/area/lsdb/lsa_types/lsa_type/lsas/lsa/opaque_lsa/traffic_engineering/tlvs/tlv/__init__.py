...
class tlv(PybindBase):
  ...
  """
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.__router_address = YANGDynClass(
            base=router_address.router_address,
            is_container="container",
        ...
        self.__node_attribute = YANGDynClass(
            base=node_attribute.node_attribute,
            is_container="container",
            yang_name="node-attribute",
            parent=self,
            path_helper=self._path_helper,
            extmethods=self._extmethods,
            register_paths=True,
