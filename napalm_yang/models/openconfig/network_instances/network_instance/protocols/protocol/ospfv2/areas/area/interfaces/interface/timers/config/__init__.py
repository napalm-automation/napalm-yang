...
interface
  """
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.__dead_interval = YANGDynClass(
        ...
        self.__retransmission_interval = YANGDynClass(
            ...
            is_leaf=True,
            yang_name="retransmission-interval",
            parent=self,
            path_helper=self._path_helper,
            extmethods=self._extmethods,
            register_paths=True,
...
retransmitting an unacknowledged LSA.
    ...
    retransmission_interval = __builtin__.property(
        _get_retransmission_interval, _set_retransmission_interval
    )
