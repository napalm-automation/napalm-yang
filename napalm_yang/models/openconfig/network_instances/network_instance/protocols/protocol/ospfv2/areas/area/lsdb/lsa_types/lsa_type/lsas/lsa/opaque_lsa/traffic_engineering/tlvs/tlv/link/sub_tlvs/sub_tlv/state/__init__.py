...
class state(PybindBase):
  ...
  """
    __slots__ = (
        ...
        "__metric",
        "__maximum_bandwidth",
        "__maximum_reservable_bandwidth",
    )
    ...
    def __init__(self, *args, **kwargs):
            ...
            base=[
                RestrictedClassType(
                    ...
                    restriction_arg={
                        ...
                        "oc-ospf-types:TE_LINK_TYPE": {
                            "@module": "openconfig-ospf-types",
                            "@namespace": "http://openconfig.net/yang/ospf-types",
                        },
                        "oc-ospft:TE_LINK_TYPE": {
                            "@module": "openconfig-ospf-types",
                            "@namespace": "http://openconfig.net/yang/ospf-types",
                        },
                        "TE_LINK_ID": {
                        ...
                        "oc-ospf-types:TE_LINK_LOCAL_IP": {
                            "@module": "openconfig-ospf-types",
                            "@namespace": "http://openconfig.net/yang/ospf-types",
                        },
                        "oc-ospft:TE_LINK_LOCAL_IP": {
                            "@module": "openconfig-ospf-types",
                            "@namespace": "http://openconfig.net/yang/ospf-types",
                        },
                        "TE_LINK_REMOTE_IP": {
                        ...
                        "oc-ospf-types:TE_LINK_REMOTE_IP": {
                            "@module": "openconfig-ospf-types",
                            "@namespace": "http://openconfig.net/yang/ospf-types",
                        },
                        "oc-ospft:TE_LINK_REMOTE_IP": {
                            "@module": "openconfig-ospf-types",
                            "@namespace": "http://openconfig.net/yang/ospf-types",
                        },
                        "TE_LINK_METRIC": {
                        ...
                        "oc-ospf-types:TE_LINK_METRIC": {
                            "@module": "openconfig-ospf-types",
                            "@namespace": "http://openconfig.net/yang/ospf-types",
                        },
                        "oc-ospft:TE_LINK_METRIC": {
                            "@module": "openconfig-ospf-types",
                            "@namespace": "http://openconfig.net/yang/ospf-types",
                        },
                        "TE_LINK_MAXIMUM_BANDWIDTH": {
                            "@module": "openconfig-ospf-types",
                            "@namespace": "http://openconfig.net/yang/ospf-types",
                        },
                        "oc-ospf-types:TE_LINK_MAXIMUM_BANDWIDTH": {
                            "@module": "openconfig-ospf-types",
                            "@namespace": "http://openconfig.net/yang/ospf-types",
                        },
                        "oc-ospft:TE_LINK_MAXIMUM_BANDWIDTH": {
                            "@module": "openconfig-ospf-types",
                            "@namespace": "http://openconfig.net/yang/ospf-types",
                        },
                        "TE_LINK_MAXIMUM_RESERVABLE_BANDWIDTH": {
                            "@module": "openconfig-ospf-types",
                            "@namespace": "http://openconfig.net/yang/ospf-types",
                        },
                        "oc-ospf-types:TE_LINK_MAXIMUM_RESERVABLE_BANDWIDTH": {
                            "@module": "openconfig-ospf-types",
                            "@namespace": "http://openconfig.net/yang/ospf-types",
                        },
                        "oc-ospft:TE_LINK_MAXIMUM_RESERVABLE_BANDWIDTH": {
                            "@module": "openconfig-ospf-types",
                            "@namespace": "http://openconfig.net/yang/ospf-types",
                        },
                        "TE_LINK_UNRESERVED_BANDWIDTH": {
                            "@module": "openconfig-ospf-types",
                            "@namespace": "http://openconfig.net/yang/ospf-types",
                        },
                        "oc-ospf-types:TE_LINK_UNRESERVED_BANDWIDTH": {
                            "@module": "openconfig-ospf-types",
                            "@namespace": "http://openconfig.net/yang/ospf-types",
                        },
                        "oc-ospft:TE_LINK_UNRESERVED_BANDWIDTH": {
                            "@module": "openconfig-ospf-types",
                            "@namespace": "http://openconfig.net/yang/ospf-types",
                        },
                        "TE_LINK_ADMIN_GROUP": {
                        ...
                        "oc-ospf-types:TE_LINK_ADMIN_GROUP": {
                            "@module": "openconfig-ospf-types",
                            "@namespace": "http://openconfig.net/yang/ospf-types",
                        },
                        "oc-ospft:TE_LINK_ADMIN_GROUP": {
                            "@module": "openconfig-ospf-types",
                            "@namespace": "http://openconfig.net/yang/ospf-types",
                        },
                    },
        ...
        self.__link_type = YANGDynClass(
            base=RestrictedClassType(
                base_type=six.text_type,
                restriction_type="dict_key",
                restriction_arg={
                    "POINT_TO_POINT": {}, "MULTI_ACCESS": {}, "UNKNOWN": {}
                },
            ),
            is_leaf=True,
            yang_name="link-type",
        ...
        self.__local_ip_address = YANGDynClass(
            base=TypedListType(
        ...
        self.__remote_ip_address = YANGDynClass(
            base=TypedListType(
                allowed_type=RestrictedClassType(
                    base_type=RestrictedClassType(
                        base_type=six.text_type,
        ...
        self.__maximum_bandwidth = YANGDynClass(
            base=RestrictedClassType(
                base_type=bitarray, restriction_dict={"length": ["32"]}
            ),
            is_leaf=True,
            yang_name="maximum-bandwidth",
            parent=self,
            path_helper=self._path_helper,
            extmethods=self._extmethods,
            register_paths=True,
        ...
        self.__maximum_reservable_bandwidth = YANGDynClass(
            base=RestrictedClassType(
                base_type=bitarray, restriction_dict={"length": ["32"]}
            ),
            is_leaf=True,
            yang_name="maximum-reservable-bandwidth",
            parent=self,
            path_helper=self._path_helper,
            extmethods=self._extmethods,
            register_paths=True,
...
a 32-bit IEEE floating-point number
    ...
    maximum_reservable_bandwidth = __builtin__.property(
        _get_maximum_reservable_bandwidth
    )
    ...
    _pyangbind_elements = OrderedDict(
        [
            ...
            ("maximum_reservable_bandwidth", maximum_reservable_bandwidth),
        ]
    )
