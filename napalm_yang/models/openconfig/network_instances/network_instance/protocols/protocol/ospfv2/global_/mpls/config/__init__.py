...
class config(PybindBase):
  ...
  """
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.__traffic_engineering_extensions = YANGDynClass(
            base=YANGBool,
            is_leaf=True,
            yang_name="traffic-engineering-extensions",
            parent=self,
...
Opaque LSAs
    ...
    traffic_engineering_extensions = __builtin__.property(
        _get_traffic_engineering_extensions, _set_traffic_engineering_extensions
    )

    _pyangbind_elements = OrderedDict(
        [("traffic_engineering_extensions", traffic_engineering_extensions)]
    )
