...
class state(PybindBase):
  ...
  """
    __slots__ = (
        ...
        "_extmethods",
        "__type",
        "__local_ipv4_addresses",
        "__local_ipv6_addresses",
    )
    ...
    def __init__(self, *args, **kwargs):
            ...
            base=[
                RestrictedClassType(
                    ...
                    restriction_arg={
                        ...
                        "oc-ospf-types:NODE_IPV4_LOCAL_ADDRESS": {
                            "@module": "openconfig-ospf-types",
                            "@namespace": "http://openconfig.net/yang/ospf-types",
                        },
                        "oc-ospft:NODE_IPV4_LOCAL_ADDRESS": {
                            "@module": "openconfig-ospf-types",
                            "@namespace": "http://openconfig.net/yang/ospf-types",
                        },
                        ...
                        "oc-ospf-types:NODE_IPV6_LOCAL_ADDRESS": {
                            "@module": "openconfig-ospf-types",
                            "@namespace": "http://openconfig.net/yang/ospf-types",
                        },
                        "oc-ospft:NODE_IPV6_LOCAL_ADDRESS": {
                            "@module": "openconfig-ospf-types",
                            "@namespace": "http://openconfig.net/yang/ospf-types",
                        },
                    },
        ...
        self.__local_ipv4_addresses = YANGDynClass(
            base=TypedListType(
            ...
            is_leaf=False,
            yang_name="local-ipv4-addresses",
            parent=self,
            path_helper=self._path_helper,
            extmethods=self._extmethods,
            register_paths=True,
        ...
        self.__local_ipv6_addresses = YANGDynClass(
            base=TypedListType(
                allowed_type=RestrictedClassType(
                    base_type=six.text_type,
                    restriction_dict={
            ...
            is_leaf=False,
            yang_name="local-ipv6-addresses",
            parent=self,
            path_helper=self._path_helper,
            extmethods=self._extmethods,
            register_paths=True,
