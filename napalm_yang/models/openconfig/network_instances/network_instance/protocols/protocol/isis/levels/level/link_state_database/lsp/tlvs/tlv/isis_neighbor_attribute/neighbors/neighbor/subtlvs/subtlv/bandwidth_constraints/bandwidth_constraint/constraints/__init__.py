...
Constraints sub-TLV
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'network-instances', u'network-instance', u'protocols', u'protocol', u'isis', u'levels', u'level', u'link-state-database', u'lsp', u'tlvs', u'tlv', u'isis-neighbor-attribute', u'neighbors', u'neighbor', u'subtlvs', u'subtlv', u'bandwidth-constraints', u'bandwidth-constraint', u'constraints']

  def _get_constraint(self):
    """
    Getter method for constraint, mapped from YANG variable /network_instances/network_instance/protocols/protocol/isis/levels/level/link_state_database/lsp/tlvs/tlv/isis_neighbor_attribute/neighbors/neighbor/subtlvs/subtlv/bandwidth_constraints/bandwidth_constraint/constraints/constraint (list)
...
being indicated by constraint-id N.
  ...
  def _set_constraint(self, v, load=False):
    """
    Setter method for constraint, mapped from YANG variable /network_instances/network_instance/protocols/protocol/isis/levels/level/link_state_database/lsp/tlvs/tlv/isis_neighbor_attribute/neighbors/neighbor/subtlvs/subtlv/bandwidth_constraints/bandwidth_constraint/constraints/constraint (list)
