...
class config(PybindBase):
  ...
  """
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.__advertise_high_metric = YANGDynClass(
            base=YANGBool,
            default=YANGBool("false"),
            is_leaf=True,
            yang_name="advertise-high-metric",
            parent=self,
            path_helper=self._path_helper,
            extmethods=self._extmethods,
            register_paths=True,
...
with a value of 63.
    ...
    advertise_high_metric = __builtin__.property(
        _get_advertise_high_metric, _set_advertise_high_metric
    )

    _pyangbind_elements = OrderedDict(
        [
            ("set_bit", set_bit),
            ("set_bit_on_boot", set_bit_on_boot),
            ("advertise_high_metric", advertise_high_metric),
        ]
    )
