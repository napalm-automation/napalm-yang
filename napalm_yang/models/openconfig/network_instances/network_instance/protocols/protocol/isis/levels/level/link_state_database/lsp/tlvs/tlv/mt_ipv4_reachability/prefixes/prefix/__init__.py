...
reachability TLV.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__mt_id','__prefix','__state','__subtlvs','__undefined_subtlvs',)
...
being advertised.
  ...
  _pyangbind_elements = {'mt_id': mt_id, 'prefix': prefix, 'state': state, 'subtlvs': subtlvs, 'undefined_subtlvs': undefined_subtlvs, }
