...
particular level on an IS-IS enabled interface.
  """
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.__packet_counters = YANGDynClass(
            base=packet_counters.packet_counters,
            is_container="container",
            yang_name="packet-counters",
            parent=self,
            path_helper=self._path_helper,
            extmethods=self._extmethods,
            register_paths=True,
        ...
        self.__adjacencies = YANGDynClass(
            base=adjacencies.adjacencies,
            is_container="container",
            yang_name="adjacencies",
            parent=self,
            path_helper=self._path_helper,
            extmethods=self._extmethods,
            register_paths=True,
        ...
        self.__hello_authentication = YANGDynClass(
            base=hello_authentication.hello_authentication,
            is_container="container",
            yang_name="hello-authentication",
            parent=self,
            path_helper=self._path_helper,
            extmethods=self._extmethods,
            register_paths=True,
...
and state information.
    ...
    hello_authentication = __builtin__.property(
        _get_hello_authentication, _set_hello_authentication
    )
    ...
    _pyangbind_elements = OrderedDict(
        [
            ...
            ("timers", timers),
            ("afi_safi", afi_safi),
            ("hello_authentication", hello_authentication),
        ]
    )
