...
reachability TLV.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__prefix','__mt_id','__state','__subtlvs','__undefined_subtlvs',)
...
TLV.
  ...
  _pyangbind_elements = {'prefix': prefix, 'mt_id': mt_id, 'state': state, 'subtlvs': subtlvs, 'undefined_subtlvs': undefined_subtlvs, }
