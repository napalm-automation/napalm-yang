...
class state(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__up_down','__prefix',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'network-instances', u'network-instance', u'protocols', u'protocol', u'isis', u'levels', u'level', u'link-state-database', u'lsp', u'tlvs', u'tlv', u'ipv4-external-reachability', u'prefixes', u'prefix', u'state']
...
prefix is first injected into IS-IS, the bit is UNSET.
  ...
  _pyangbind_elements = {'up_down': up_down, 'prefix': prefix, }
