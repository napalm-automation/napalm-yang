...
class state(PybindBase):
  ...
  """
    __slots__ = ("_path_helper", "_extmethods", "__type", "__ipv4_te_router_id")
    ...
    def _get_type(self):
        """
    Getter method for type, mapped from YANG variable /network_instances/network_instance/protocols/protocol/isis/levels/level/link_state_database/lsp/tlvs/tlv/ipv4_te_router_id/state/type (identityref)
...
expressed as a canonical name.
    ...
    def _set_type(self, v, load=False):
        """
    Setter method for type, mapped from YANG variable /network_instances/network_instance/protocols/protocol/isis/levels/level/link_state_database/lsp/tlvs/tlv/ipv4_te_router_id/state/type (identityref)
...
expressed as a canonical name.
    ...
    def _get_ipv4_te_router_id(self):
        """
    Getter method for ipv4_te_router_id, mapped from YANG variable /network_instances/network_instance/protocols/protocol/isis/levels/level/link_state_database/lsp/tlvs/tlv/ipv4_te_router_id/state/ipv4_te_router_id (inet:ipv4-address-no-zone)
...
interfaces.
    ...
    def _set_ipv4_te_router_id(self, v, load=False):
        """
    Setter method for ipv4_te_router_id, mapped from YANG variable /network_instances/network_instance/protocols/protocol/isis/levels/level/link_state_database/lsp/tlvs/tlv/ipv4_te_router_id/state/ipv4_te_router_id (inet:ipv4-address-no-zone)
    If this variable is read-only (config: false) in the
...
interfaces.
    """
        ...
        try:
            ...
            raise ValueError(
                {
                    "error-string": """ipv4_te_router_id must be of a type compatible with inet:ipv4-address-no-zone""",
                    "defined-type": "inet:ipv4-address-no-zone",
                    "generated-type": """YANGDynClass(base=RestrictedClassType(base_type=RestrictedClassType(base_type=six.text_type, restriction_dict={'pattern': '(([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])\\.){3}([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])(%[\\p{N}\\p{L}]+)?'}), restriction_dict={'pattern': '[0-9\\.]*'}), is_leaf=True, yang_name="ipv4-te-router-id", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/network-instance', defining_module='openconfig-network-instance', yang_type='inet:ipv4-address-no-zone', is_config=False)""",
                }
            )
    ...
    _pyangbind_elements = OrderedDict(
        [("type", type), ("ipv4_te_router_id", ipv4_te_router_id)]
    )
