...
class state(PybindBase):
  ...
  """
    __slots__ = ("_path_helper", "_extmethods", "__type", "__ipv6_te_router_id")
    ...
    def _get_type(self):
        """
    Getter method for type, mapped from YANG variable /network_instances/network_instance/protocols/protocol/isis/levels/level/link_state_database/lsp/tlvs/tlv/ipv6_te_router_id/state/type (identityref)
...
expressed as a canonical name.
    ...
    def _set_type(self, v, load=False):
        """
    Setter method for type, mapped from YANG variable /network_instances/network_instance/protocols/protocol/isis/levels/level/link_state_database/lsp/tlvs/tlv/ipv6_te_router_id/state/type (identityref)
...
expressed as a canonical name.
    ...
    def _get_ipv6_te_router_id(self):
        """
    Getter method for ipv6_te_router_id, mapped from YANG variable /network_instances/network_instance/protocols/protocol/isis/levels/level/link_state_database/lsp/tlvs/tlv/ipv6_te_router_id/state/ipv6_te_router_id (inet:ipv6-address)

    YANG Description: IPv6 Traffic Engineering router ID of the node. For traffic
...
interfaces.
    ...
    def _set_ipv6_te_router_id(self, v, load=False):
        """
    Setter method for ipv6_te_router_id, mapped from YANG variable /network_instances/network_instance/protocols/protocol/isis/levels/level/link_state_database/lsp/tlvs/tlv/ipv6_te_router_id/state/ipv6_te_router_id (inet:ipv6-address)
    If this variable is read-only (config: false) in the
...
interfaces.
    """
        ...
        try:
            ...
            raise ValueError(
                {
                    "error-string": """ipv6_te_router_id must be of a type compatible with inet:ipv6-address""",
                    "defined-type": "inet:ipv6-address",
                    "generated-type": """YANGDynClass(base=RestrictedClassType(base_type=six.text_type, restriction_dict={'pattern': '((:|[0-9a-fA-F]{0,4}):)([0-9a-fA-F]{0,4}:){0,5}((([0-9a-fA-F]{0,4}:)?(:|[0-9a-fA-F]{0,4}))|(((25[0-5]|2[0-4][0-9]|[01]?[0-9]?[0-9])\\.){3}(25[0-5]|2[0-4][0-9]|[01]?[0-9]?[0-9])))(%[\\p{N}\\p{L}]+)?'}), is_leaf=True, yang_name="ipv6-te-router-id", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/network-instance', defining_module='openconfig-network-instance', yang_type='inet:ipv6-address', is_config=False)""",
                }
            )
    ...
    _pyangbind_elements = OrderedDict(
        [("type", type), ("ipv6_te_router_id", ipv6_te_router_id)]
    )
