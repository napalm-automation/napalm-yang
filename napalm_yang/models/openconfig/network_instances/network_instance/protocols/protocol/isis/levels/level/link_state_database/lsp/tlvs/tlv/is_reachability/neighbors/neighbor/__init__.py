...
class neighbor(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__system_id','__state','__default_metric','__delay_metric','__expense_metric','__error_metric',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'network-instances', u'network-instance', u'protocols', u'protocol', u'isis', u'levels', u'level', u'link-state-database', u'lsp', u'tlvs', u'tlv', u'is-reachability', u'neighbors', u'neighbor']
  ...
  _pyangbind_elements = {'system_id': system_id, 'state': state, 'default_metric': default_metric, 'delay_metric': delay_metric, 'expense_metric': expense_metric, 'error_metric': error_metric, }
