...
class state(PybindBase):
  ...
  from YANG module openconfig-network-instance - based on the path /network-instances/network-instance/protocols/protocol/isis/levels/level/link-state-database/lsp/tlvs/tlv/mt-ipv4-reachability/prefixes/prefix/subTLVs/subTLVs/ipv4-source-router-id/state. Each member element of
  ...
  """
    __slots__ = (
        "_path_helper", "_extmethods", "__subtlv_type", "__ipv4_source_router_id"
    )
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.__ipv4_source_router_id = YANGDynClass(
            base=RestrictedClassType(
            ...
            is_leaf=True,
            yang_name="ipv4-source-router-id",
            parent=self,
            path_helper=self._path_helper,
            extmethods=self._extmethods,
            register_paths=True,
    ...
    def _get_subtlv_type(self):
        """
    Getter method for subtlv_type, mapped from YANG variable /network_instances/network_instance/protocols/protocol/isis/levels/level/link_state_database/lsp/tlvs/tlv/mt_ipv4_reachability/prefixes/prefix/subTLVs/subTLVs/ipv4_source_router_id/state/subtlv_type (identityref)
...
expressed as a canonical name.
    ...
    def _set_subtlv_type(self, v, load=False):
        """
    Setter method for subtlv_type, mapped from YANG variable /network_instances/network_instance/protocols/protocol/isis/levels/level/link_state_database/lsp/tlvs/tlv/mt_ipv4_reachability/prefixes/prefix/subTLVs/subTLVs/ipv4_source_router_id/state/subtlv_type (identityref)
...
expressed as a canonical name.
    ...
    def _get_ipv4_source_router_id(self):
        """
    Getter method for ipv4_source_router_id, mapped from YANG variable /network_instances/network_instance/protocols/protocol/isis/levels/level/link_state_database/lsp/tlvs/tlv/mt_ipv4_reachability/prefixes/prefix/subTLVs/subTLVs/ipv4_source_router_id/state/ipv4_source_router_id (inet:ipv4-address-no-zone)
...
another protocol.
    ...
    def _set_ipv4_source_router_id(self, v, load=False):
        """
    Setter method for ipv4_source_router_id, mapped from YANG variable /network_instances/network_instance/protocols/protocol/isis/levels/level/link_state_database/lsp/tlvs/tlv/mt_ipv4_reachability/prefixes/prefix/subTLVs/subTLVs/ipv4_source_router_id/state/ipv4_source_router_id (inet:ipv4-address-no-zone)
    If this variable is read-only (config: false) in the
...
another protocol.
    """
        ...
        try:
            ...
            raise ValueError(
                {
                    "error-string": """ipv4_source_router_id must be of a type compatible with inet:ipv4-address-no-zone""",
                    "defined-type": "inet:ipv4-address-no-zone",
                    "generated-type": """YANGDynClass(base=RestrictedClassType(base_type=RestrictedClassType(base_type=six.text_type, restriction_dict={'pattern': '(([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])\\.){3}([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])(%[\\p{N}\\p{L}]+)?'}), restriction_dict={'pattern': '[0-9\\.]*'}), is_leaf=True, yang_name="ipv4-source-router-id", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/network-instance', defining_module='openconfig-network-instance', yang_type='inet:ipv4-address-no-zone', is_config=False)""",
                }
            )
    ...
    _pyangbind_elements = OrderedDict(
        [("subtlv_type", subtlv_type), ("ipv4_source_router_id", ipv4_source_router_id)]
    )
...
class state(PybindBase):
    """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module openconfig-network-instance-l2 - based on the path /network-instances/network-instance/protocols/protocol/isis/levels/level/link-state-database/lsp/tlvs/tlv/mt-ipv4-reachability/prefixes/prefix/subTLVs/subTLVs/ipv4-source-router-id/state. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
