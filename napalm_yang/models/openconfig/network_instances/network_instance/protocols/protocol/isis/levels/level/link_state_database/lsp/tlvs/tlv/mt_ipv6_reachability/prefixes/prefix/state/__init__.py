...
class state(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__up_down','__x_bit','__s_bit','__prefix','__metric','__mt_id',)
...
portion of the structure.
  ...
  _pyangbind_elements = {'up_down': up_down, 'x_bit': x_bit, 's_bit': s_bit, 'prefix': prefix, 'metric': metric, 'mt_id': mt_id, }
