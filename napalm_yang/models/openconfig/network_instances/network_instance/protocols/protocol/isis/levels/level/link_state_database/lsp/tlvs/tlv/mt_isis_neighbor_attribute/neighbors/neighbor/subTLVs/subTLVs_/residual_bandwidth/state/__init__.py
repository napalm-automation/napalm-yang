...
class state(PybindBase):
  ...
  from YANG module openconfig-network-instance - based on the path /network-instances/network-instance/protocols/protocol/isis/levels/level/link-state-database/lsp/tlvs/tlv/mt-isis-neighbor-attribute/neighbors/neighbor/subTLVs/subTLVs/residual-bandwidth/state. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.

  YANG Description: State parameters of IS Extended Reachability sub-TLV 37.
  """
    __slots__ = ("_path_helper", "_extmethods", "__subtlv_type", "__residual_bandwidth")
    ...
    def _get_subtlv_type(self):
        """
    Getter method for subtlv_type, mapped from YANG variable /network_instances/network_instance/protocols/protocol/isis/levels/level/link_state_database/lsp/tlvs/tlv/mt_isis_neighbor_attribute/neighbors/neighbor/subTLVs/subTLVs/residual_bandwidth/state/subtlv_type (identityref)
...
expressed as a canonical name.
    ...
    def _set_subtlv_type(self, v, load=False):
        """
    Setter method for subtlv_type, mapped from YANG variable /network_instances/network_instance/protocols/protocol/isis/levels/level/link_state_database/lsp/tlvs/tlv/mt_isis_neighbor_attribute/neighbors/neighbor/subTLVs/subTLVs/residual_bandwidth/state/subtlv_type (identityref)
...
expressed as a canonical name.
    ...
    def _get_residual_bandwidth(self):
        """
    Getter method for residual_bandwidth, mapped from YANG variable /network_instances/network_instance/protocols/protocol/isis/levels/level/link_state_database/lsp/tlvs/tlv/mt_isis_neighbor_attribute/neighbors/neighbor/subTLVs/subTLVs/residual_bandwidth/state/residual_bandwidth (oc-types:ieeefloat32)
...
the sum of the component link residual bandwidths.
    """
        return self.__residual_bandwidth

    def _set_residual_bandwidth(self, v, load=False):
        """
    Setter method for residual_bandwidth, mapped from YANG variable /network_instances/network_instance/protocols/protocol/isis/levels/level/link_state_database/lsp/tlvs/tlv/mt_isis_neighbor_attribute/neighbors/neighbor/subTLVs/subTLVs/residual_bandwidth/state/residual_bandwidth (oc-types:ieeefloat32)
    If this variable is read-only (config: false) in the
...
the sum of the component link residual bandwidths.
    ...
    _pyangbind_elements = OrderedDict(
        [("subtlv_type", subtlv_type), ("residual_bandwidth", residual_bandwidth)]
    )
...
class state(PybindBase):
    """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module openconfig-network-instance-l2 - based on the path /network-instances/network-instance/protocols/protocol/isis/levels/level/link-state-database/lsp/tlvs/tlv/mt-isis-neighbor-attribute/neighbors/neighbor/subTLVs/subTLVs/residual-bandwidth/state. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
