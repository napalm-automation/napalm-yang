...
class inter_level_propagation_policies(PybindBase):
  ...
  """
    __slots__ = (
        "_path_helper", "_extmethods", "__level1_to_level2", "__level2_to_level1"
    )
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.__level1_to_level2 = YANGDynClass(
            base=level1_to_level2.level1_to_level2,
            is_container="container",
            yang_name="level1-to-level2",
            parent=self,
        ...
        self.__level2_to_level1 = YANGDynClass(
            base=level2_to_level1.level2_to_level1,
            is_container="container",
            yang_name="level2-to-level1",
            parent=self,
            path_helper=self._path_helper,
            extmethods=self._extmethods,
            register_paths=True,
...
Level2 to Level 1.
    ...
    level1_to_level2 = __builtin__.property(
        _get_level1_to_level2, _set_level1_to_level2
    )
    level2_to_level1 = __builtin__.property(
        _get_level2_to_level1, _set_level2_to_level1
    )

    _pyangbind_elements = OrderedDict(
        [("level1_to_level2", level1_to_level2), ("level2_to_level1", level2_to_level1)]
    )
