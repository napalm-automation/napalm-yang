...
class state(PybindBase):
  ...
  from YANG module openconfig-network-instance - based on the path /network-instances/network-instance/protocols/protocol/isis/levels/level/link-state-database/lsp/tlvs/tlv/isis-neighbor-attribute/neighbors/neighbor/subTLVs/subTLVs/bandwidth-constraints/state. Each member element of
  ...
  """
    ...
    def _get_subtlv_type(self):
        """
    Getter method for subtlv_type, mapped from YANG variable /network_instances/network_instance/protocols/protocol/isis/levels/level/link_state_database/lsp/tlvs/tlv/isis_neighbor_attribute/neighbors/neighbor/subTLVs/subTLVs/bandwidth_constraints/state/subtlv_type (identityref)
...
expressed as a canonical name.
    ...
    def _set_subtlv_type(self, v, load=False):
        """
    Setter method for subtlv_type, mapped from YANG variable /network_instances/network_instance/protocols/protocol/isis/levels/level/link_state_database/lsp/tlvs/tlv/isis_neighbor_attribute/neighbors/neighbor/subTLVs/subTLVs/bandwidth_constraints/state/subtlv_type (identityref)
...
expressed as a canonical name.
    ...
    def _get_model_id(self):
        """
    Getter method for model_id, mapped from YANG variable /network_instances/network_instance/protocols/protocol/isis/levels/level/link_state_database/lsp/tlvs/tlv/isis_neighbor_attribute/neighbors/neighbor/subTLVs/subTLVs/bandwidth_constraints/state/model_id (uint8)

    YANG Description: Identifier for the Bandwidth Constraints  Model currently in
use by the LSR initiating the IGP advertisement.
    """
        return self.__model_id

    def _set_model_id(self, v, load=False):
        """
    Setter method for model_id, mapped from YANG variable /network_instances/network_instance/protocols/protocol/isis/levels/level/link_state_database/lsp/tlvs/tlv/isis_neighbor_attribute/neighbors/neighbor/subTLVs/subTLVs/bandwidth_constraints/state/model_id (uint8)
    If this variable is read-only (config: false) in the
...
use by the LSR initiating the IGP advertisement.
    ...
    def _get_reserved(self):
        """
    Getter method for reserved, mapped from YANG variable /network_instances/network_instance/protocols/protocol/isis/levels/level/link_state_database/lsp/tlvs/tlv/isis_neighbor_attribute/neighbors/neighbor/subTLVs/subTLVs/bandwidth_constraints/state/reserved (uint32)

    YANG Description: Should be set to zero by the LSR generating the sub-TLV and
should be ignored by the LSR receiving the sub-TLV.
    """
        return self.__reserved

    def _set_reserved(self, v, load=False):
        """
    Setter method for reserved, mapped from YANG variable /network_instances/network_instance/protocols/protocol/isis/levels/level/link_state_database/lsp/tlvs/tlv/isis_neighbor_attribute/neighbors/neighbor/subTLVs/subTLVs/bandwidth_constraints/state/reserved (uint32)
    If this variable is read-only (config: false) in the
...
should be ignored by the LSR receiving the sub-TLV.
            ...
            raise ValueError(
                {
                    ...
                    "defined-type": "uint32",
                    "generated-type": """YANGDynClass(base=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), is_leaf=True, yang_name="reserved", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/network-instance', defining_module='openconfig-network-instance', yang_type='uint32', is_config=False)""",
                }
            )
    ...
    def _get_bandwidth_constraints(self):
        """
    Getter method for bandwidth_constraints, mapped from YANG variable /network_instances/network_instance/protocols/protocol/isis/levels/level/link_state_database/lsp/tlvs/tlv/isis_neighbor_attribute/neighbors/neighbor/subTLVs/subTLVs/bandwidth_constraints/state/bandwidth_constraints (oc-types:ieeefloat32)
...
per secondy.
    ...
    def _set_bandwidth_constraints(self, v, load=False):
        """
    Setter method for bandwidth_constraints, mapped from YANG variable /network_instances/network_instance/protocols/protocol/isis/levels/level/link_state_database/lsp/tlvs/tlv/isis_neighbor_attribute/neighbors/neighbor/subTLVs/subTLVs/bandwidth_constraints/state/bandwidth_constraints (oc-types:ieeefloat32)
    If this variable is read-only (config: false) in the
...
per secondy.
    """
        ...
        try:
            ...
            raise ValueError(
                {
                    "error-string": """bandwidth_constraints must be of a type compatible with oc-types:ieeefloat32""",
                    "defined-type": "oc-types:ieeefloat32",
                    "generated-type": """YANGDynClass(base=TypedListType(allowed_type=RestrictedClassType(base_type=bitarray, restriction_dict={'length': ['32']})), is_leaf=False, yang_name="bandwidth-constraints", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/network-instance', defining_module='openconfig-network-instance', yang_type='oc-types:ieeefloat32', is_config=False)""",
                }
            )
...
class state(PybindBase):
    """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module openconfig-network-instance-l2 - based on the path /network-instances/network-instance/protocols/protocol/isis/levels/level/link-state-database/lsp/tlvs/tlv/isis-neighbor-attribute/neighbors/neighbor/subTLVs/subTLVs/bandwidth-constraints/state. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
