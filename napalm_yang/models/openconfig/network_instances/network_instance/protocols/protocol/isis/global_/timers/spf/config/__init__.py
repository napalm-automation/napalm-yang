...
class config(PybindBase):
  ...
  """
    __slots__ = (
        ...
        "_extmethods",
        "__spf_hold_interval",
        "__spf_first_interval",
        "__spf_second_interval",
    )
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.__spf_hold_interval = YANGDynClass(
        ...
        self.__spf_second_interval = YANGDynClass(
            base=RestrictedClassType(
                base_type=long,
                restriction_dict={"range": ["0..18446744073709551615"]},
                int_size=64,
...
SPF calculation.
    ...
    spf_hold_interval = __builtin__.property(
        _get_spf_hold_interval, _set_spf_hold_interval
    )
    spf_first_interval = __builtin__.property(
        _get_spf_first_interval, _set_spf_first_interval
    )
    spf_second_interval = __builtin__.property(
        _get_spf_second_interval, _set_spf_second_interval
    )

    _pyangbind_elements = OrderedDict(
        [
            ("spf_hold_interval", spf_hold_interval),
            ("spf_first_interval", spf_first_interval),
            ("spf_second_interval", spf_second_interval),
        ]
    )
