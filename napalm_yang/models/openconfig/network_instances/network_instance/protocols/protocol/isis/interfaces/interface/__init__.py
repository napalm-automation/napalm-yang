...
class interface(PybindBase):
  ...
  """
  __slots__ = ('_path_helper', '_extmethods', '__interface_id','__config','__state','__circuit_counters','__authentication','__afi_safi','__levels','__timers','__bfd','__interface_ref',)
