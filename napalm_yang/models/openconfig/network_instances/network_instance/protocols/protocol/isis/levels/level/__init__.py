...
particular level within the IS-IS protocol instance
  """
    __slots__ = (
        ...
        "__config",
        "__state",
        "__system_level_counters",
        "__link_state_database",
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.__system_level_counters = YANGDynClass(
            base=system_level_counters.system_level_counters,
            is_container="container",
            yang_name="system-level-counters",
            parent=self,
            path_helper=self._path_helper,
            extmethods=self._extmethods,
            register_paths=True,
        ...
        self.__link_state_database = YANGDynClass(
            base=link_state_database.link_state_database,
            is_container="container",
            yang_name="link-state-database",
            parent=self,
            path_helper=self._path_helper,
            extmethods=self._extmethods,
            register_paths=True,
        ...
        self.__traffic_engineering = YANGDynClass(
            base=traffic_engineering.traffic_engineering,
            is_container="container",
        ...
        self.__route_preference = YANGDynClass(
            base=route_preference.route_preference,
            is_container="container",
            yang_name="route-preference",
            parent=self,
            path_helper=self._path_helper,
            extmethods=self._extmethods,
            register_paths=True,
...
external, level2 external).
    ...
    system_level_counters = __builtin__.property(
        _get_system_level_counters, _set_system_level_counters
    )
    link_state_database = __builtin__.property(
        _get_link_state_database, _set_link_state_database
    )
    traffic_engineering = __builtin__.property(
        _get_traffic_engineering, _set_traffic_engineering
    )
    route_preference = __builtin__.property(
        _get_route_preference, _set_route_preference
    )
    ...
    _pyangbind_elements = OrderedDict(
        [
            ...
            ("config", config),
            ("state", state),
            ("system_level_counters", system_level_counters),
            ("link_state_database", link_state_database),
