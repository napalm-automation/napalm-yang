...
class config(PybindBase):
  ...
  """
    __slots__ = (
        "_path_helper",
        "_extmethods",
        "__lsp_lifetime_interval",
        "__lsp_refresh_interval",
    )
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.__lsp_lifetime_interval = YANGDynClass(
            ...
            is_leaf=True,
            yang_name="lsp-lifetime-interval",
            parent=self,
        ...
        self.__lsp_refresh_interval = YANGDynClass(
            base=RestrictedClassType(
                base_type=int, restriction_dict={"range": ["0..65535"]}, int_size=16
            ),
            is_leaf=True,
            yang_name="lsp-refresh-interval",
            parent=self,
            path_helper=self._path_helper,
            extmethods=self._extmethods,
            register_paths=True,
...
that a device originates is transmitted in LSPs.
    ...
    lsp_lifetime_interval = __builtin__.property(
        _get_lsp_lifetime_interval, _set_lsp_lifetime_interval
    )
    lsp_refresh_interval = __builtin__.property(
        _get_lsp_refresh_interval, _set_lsp_refresh_interval
    )

    _pyangbind_elements = OrderedDict(
        [
            ("lsp_lifetime_interval", lsp_lifetime_interval),
