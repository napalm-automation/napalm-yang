...
class state(PybindBase):
  ...
  from YANG module openconfig-network-instance - based on the path /network-instances/network-instance/protocols/protocol/isis/levels/level/link-state-database/lsp/tlvs/tlv/mt-isis-neighbor-attribute/neighbors/neighbor/subTLVs/subTLVs/unconstrained-lsp/state. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.

  YANG Description: State parameters of sub-TLV 23.
  """
    __slots__ = ("_path_helper", "_extmethods", "__subtlv_type", "__unconstrained_lsp")
    ...
    def _get_subtlv_type(self):
        """
    Getter method for subtlv_type, mapped from YANG variable /network_instances/network_instance/protocols/protocol/isis/levels/level/link_state_database/lsp/tlvs/tlv/mt_isis_neighbor_attribute/neighbors/neighbor/subTLVs/subTLVs/unconstrained_lsp/state/subtlv_type (identityref)
...
expressed as a canonical name.
    ...
    def _set_subtlv_type(self, v, load=False):
        """
    Setter method for subtlv_type, mapped from YANG variable /network_instances/network_instance/protocols/protocol/isis/levels/level/link_state_database/lsp/tlvs/tlv/mt_isis_neighbor_attribute/neighbors/neighbor/subTLVs/subTLVs/unconstrained_lsp/state/subtlv_type (identityref)
...
expressed as a canonical name.
    ...
    def _get_unconstrained_lsp(self):
        """
    Getter method for unconstrained_lsp, mapped from YANG variable /network_instances/network_instance/protocols/protocol/isis/levels/level/link_state_database/lsp/tlvs/tlv/mt_isis_neighbor_attribute/neighbors/neighbor/subTLVs/subTLVs/unconstrained_lsp/state/unconstrained_lsp (uint16)

    YANG Description: Unconstrained TE LSP count(TE Label Switched Paths (LSPs)
signalled with zero bandwidth).
    """
        return self.__unconstrained_lsp

    def _set_unconstrained_lsp(self, v, load=False):
        """
    Setter method for unconstrained_lsp, mapped from YANG variable /network_instances/network_instance/protocols/protocol/isis/levels/level/link_state_database/lsp/tlvs/tlv/mt_isis_neighbor_attribute/neighbors/neighbor/subTLVs/subTLVs/unconstrained_lsp/state/unconstrained_lsp (uint16)
    If this variable is read-only (config: false) in the
...
signalled with zero bandwidth).
    """
        ...
        try:
            ...
            raise ValueError(
                {
                    "error-string": """unconstrained_lsp must be of a type compatible with uint16""",
                    "defined-type": "uint16",
                    "generated-type": """YANGDynClass(base=RestrictedClassType(base_type=int, restriction_dict={'range': ['0..65535']},int_size=16), is_leaf=True, yang_name="unconstrained-lsp", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/network-instance', defining_module='openconfig-network-instance', yang_type='uint16', is_config=False)""",
                }
            )
    ...
    _pyangbind_elements = OrderedDict(
        [("subtlv_type", subtlv_type), ("unconstrained_lsp", unconstrained_lsp)]
    )
...
class state(PybindBase):
    """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module openconfig-network-instance-l2 - based on the path /network-instances/network-instance/protocols/protocol/isis/levels/level/link-state-database/lsp/tlvs/tlv/mt-isis-neighbor-attribute/neighbors/neighbor/subTLVs/subTLVs/unconstrained-lsp/state. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
