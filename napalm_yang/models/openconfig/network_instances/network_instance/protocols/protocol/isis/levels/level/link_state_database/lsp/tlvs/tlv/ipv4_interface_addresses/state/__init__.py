...
class state(PybindBase):
  ...
  """
    __slots__ = ("_path_helper", "_extmethods", "__type", "__ipv4_interface_addresses")
    ...
    def _get_type(self):
        """
    Getter method for type, mapped from YANG variable /network_instances/network_instance/protocols/protocol/isis/levels/level/link_state_database/lsp/tlvs/tlv/ipv4_interface_addresses/state/type (identityref)
...
expressed as a canonical name.
    ...
    def _set_type(self, v, load=False):
        """
    Setter method for type, mapped from YANG variable /network_instances/network_instance/protocols/protocol/isis/levels/level/link_state_database/lsp/tlvs/tlv/ipv4_interface_addresses/state/type (identityref)
...
expressed as a canonical name.
    ...
    def _get_ipv4_interface_addresses(self):
        """
    Getter method for ipv4_interface_addresses, mapped from YANG variable /network_instances/network_instance/protocols/protocol/isis/levels/level/link_state_database/lsp/tlvs/tlv/ipv4_interface_addresses/state/ipv4_interface_addresses (inet:ipv4-prefix)
...
over which this PDU is to be transmitted.
    ...
    def _set_ipv4_interface_addresses(self, v, load=False):
        """
    Setter method for ipv4_interface_addresses, mapped from YANG variable /network_instances/network_instance/protocols/protocol/isis/levels/level/link_state_database/lsp/tlvs/tlv/ipv4_interface_addresses/state/ipv4_interface_addresses (inet:ipv4-prefix)
    If this variable is read-only (config: false) in the
...
over which this PDU is to be transmitted.
    """
        ...
        try:
            ...
            raise ValueError(
                {
                    "error-string": """ipv4_interface_addresses must be of a type compatible with inet:ipv4-prefix""",
                    "defined-type": "inet:ipv4-prefix",
                    "generated-type": """YANGDynClass(base=TypedListType(allowed_type=RestrictedClassType(base_type=six.text_type, restriction_dict={'pattern': '(([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])\\.){3}([0-9]|[1-9][0-9]|1[0-9][0-9]|2[0-4][0-9]|25[0-5])/(([0-9])|([1-2][0-9])|(3[0-2]))'})), is_leaf=False, yang_name="ipv4-interface-addresses", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/network-instance', defining_module='openconfig-network-instance', yang_type='inet:ipv4-prefix', is_config=False)""",
                }
            )
    ...
    _pyangbind_elements = OrderedDict(
        [("type", type), ("ipv4_interface_addresses", ipv4_interface_addresses)]
    )
