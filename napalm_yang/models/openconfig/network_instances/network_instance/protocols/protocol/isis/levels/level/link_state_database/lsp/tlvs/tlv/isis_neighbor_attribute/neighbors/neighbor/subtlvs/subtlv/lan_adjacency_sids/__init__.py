...
class lan_adjacency_sids(PybindBase):
  ...
  from YANG module openconfig-network-instance - based on the path /network-instances/network-instance/protocols/protocol/isis/levels/level/link-state-database/lsp/tlvs/tlv/isis-neighbor-attribute/neighbors/neighbor/subtlvs/subtlv/lan-adjacency-sids. Each member element of
...
SIDs
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'network-instances', u'network-instance', u'protocols', u'protocol', u'isis', u'levels', u'level', u'link-state-database', u'lsp', u'tlvs', u'tlv', u'isis-neighbor-attribute', u'neighbors', u'neighbor', u'subtlvs', u'subtlv', u'lan-adjacency-sids']

  def _get_lan_adjacency_sid(self):
    """
    Getter method for lan_adjacency_sid, mapped from YANG variable /network_instances/network_instance/protocols/protocol/isis/levels/level/link_state_database/lsp/tlvs/tlv/isis_neighbor_attribute/neighbors/neighbor/subtlvs/subtlv/lan_adjacency_sids/lan_adjacency_sid (list)
...
it.
  ...
  def _set_lan_adjacency_sid(self, v, load=False):
    """
    Setter method for lan_adjacency_sid, mapped from YANG variable /network_instances/network_instance/protocols/protocol/isis/levels/level/link_state_database/lsp/tlvs/tlv/isis_neighbor_attribute/neighbors/neighbor/subtlvs/subtlv/lan_adjacency_sids/lan_adjacency_sid (list)
...
class lan_adjacency_sids(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module openconfig-network-instance-l2 - based on the path /network-instances/network-instance/protocols/protocol/isis/levels/level/link-state-database/lsp/tlvs/tlv/isis-neighbor-attribute/neighbors/neighbor/subtlvs/subtlv/lan-adjacency-sids. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
