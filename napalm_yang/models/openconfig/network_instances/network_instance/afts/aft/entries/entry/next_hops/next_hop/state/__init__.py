...
next-hop entry
  """
  __slots__ = ('_path_helper', '_extmethods', '__index','__weight','__ip_address','__mac_address','__popped_mpls_label_stack','__pushed_mpls_label_stack','__decapsulate_header','__encapsulate_header','__origin_protocol',)
