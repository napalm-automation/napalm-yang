...
class config(PybindBase):
  ...
  from YANG module openconfig-network-instance - based on the path /network-instances/network-instance/afts/ipv6-unicast/ipv6-entry/next-hops/next-hop/config. Each member element of
...
entry
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'network-instances', u'network-instance', u'afts', u'ipv6-unicast', u'ipv6-entry', u'next-hops', u'next-hop', u'config']

  def _get_index(self):
    """
    Getter method for index, mapped from YANG variable /network_instances/network_instance/afts/ipv6_unicast/ipv6_entry/next_hops/next_hop/config/index (uint64)
  ...
  def _set_index(self, v, load=False):
    """
    Setter method for index, mapped from YANG variable /network_instances/network_instance/afts/ipv6_unicast/ipv6_entry/next_hops/next_hop/config/index (uint64)
...
class config(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module openconfig-network-instance-l2 - based on the path /network-instances/network-instance/afts/ipv6-unicast/ipv6-entry/next-hops/next-hop/config. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
