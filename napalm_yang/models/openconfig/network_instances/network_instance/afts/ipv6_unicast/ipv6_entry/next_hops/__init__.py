...
class next_hops(PybindBase):
  ...
  from YANG module openconfig-network-instance - based on the path /network-instances/network-instance/afts/ipv6-unicast/ipv6-entry/next-hops. Each member element of
 ...
 indicated).
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'network-instances', u'network-instance', u'afts', u'ipv6-unicast', u'ipv6-entry', u'next-hops']

  def _get_next_hop(self):
    """
    Getter method for next_hop, mapped from YANG variable /network_instances/network_instance/afts/ipv6_unicast/ipv6_entry/next_hops/next_hop (list)
...
not be included within this list.
  ...
  def _set_next_hop(self, v, load=False):
    """
    Setter method for next_hop, mapped from YANG variable /network_instances/network_instance/afts/ipv6_unicast/ipv6_entry/next_hops/next_hop (list)
...
class next_hops(PybindBase):
  """
  This class was auto-generated by the PythonClass plugin for PYANG
  from YANG module openconfig-network-instance-l2 - based on the path /network-instances/network-instance/afts/ipv6-unicast/ipv6-entry/next-hops. Each member element of
  the container is represented as a class variable - with a specific
  YANG type.
