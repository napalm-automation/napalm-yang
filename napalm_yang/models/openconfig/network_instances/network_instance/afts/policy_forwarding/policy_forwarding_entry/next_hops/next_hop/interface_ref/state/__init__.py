...
to indicate the base interface.
  ...
  def _get_subinterface(self):
    """
    Getter method for subinterface, mapped from YANG variable /network_instances/network_instance/afts/policy_forwarding/policy_forwarding_entry/next_hops/next_hop/interface_ref/state/subinterface (leafref)
...
is requuired, this leaf should not be set.
  ...
  def _set_subinterface(self, v, load=False):
    """
    Setter method for subinterface, mapped from YANG variable /network_instances/network_instance/afts/policy_forwarding/policy_forwarding_entry/next_hops/next_hop/interface_ref/state/subinterface (leafref)
    If this variable is read-only (config: false) in the
