...
the MPLS header.
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'qos', u'classifiers', u'classifier', u'terms', u'term', u'conditions', u'mpls', u'config']

  def _get_traffic_class(self):
    """
    Getter method for traffic_class, mapped from YANG variable /qos/classifiers/classifier/terms/term/conditions/mpls/config/traffic_class (uint8)
...
formerly known as the EXP bits.
  ...
  def _set_traffic_class(self, v, load=False):
    """
    Setter method for traffic_class, mapped from YANG variable /qos/classifiers/classifier/terms/term/conditions/mpls/config/traffic_class (uint8)
