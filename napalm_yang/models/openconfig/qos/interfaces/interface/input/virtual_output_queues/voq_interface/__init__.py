...
queue is instantiated at this interface.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__name','__config','__state','__queues',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'qos', u'interfaces', u'interface', u'input', u'virtual-output-queues', u'voq-interface']
...
instantiated on an interface.
  ...
  _pyangbind_elements = {'name': name, 'config': config, 'state': state, 'queues': queues, }
