...
class dns(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__config','__state','__servers','__host_entries',)
  ...
  _pyangbind_elements = {'config': config, 'state': state, 'servers': servers, 'host_entries': host_entries, }
