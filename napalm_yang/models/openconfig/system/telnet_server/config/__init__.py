...
class config(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__enable','__timeout','__rate_limit','__session_limit',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'system', u'telnet-server', u'config']
...
telnet, ...) 
  ...
  _pyangbind_elements = {'enable': enable, 'timeout': timeout, 'rate_limit': rate_limit, 'session_limit': session_limit, }
