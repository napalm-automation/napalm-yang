...
class ntp_keys(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__ntp_key',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'system', u'ntp', u'ntp-keys']

  def _initialized_ntp_key(self):
    return self.__ntp_key is not None
  ...
  _pyangbind_elements = {'ntp_key': ntp_key, }
