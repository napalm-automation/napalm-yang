...
class config(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__enabled','__ntp_source_address','__enable_ntp_auth',)
...
authentication key to synchronize the time.
  ...
  _pyangbind_elements = {'enabled': enabled, 'ntp_source_address': ntp_source_address, 'enable_ntp_auth': enable_ntp_auth, }
