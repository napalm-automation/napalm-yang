...
class ntp(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__config','__state','__ntp_keys','__servers',)
  ...
  _pyangbind_elements = {'config': config, 'state': state, 'ntp_keys': ntp_keys, 'servers': servers, }
