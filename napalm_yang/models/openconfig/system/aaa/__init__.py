...
class aaa(PybindBase):
  ...
  """
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.__authorization = YANGDynClass(
            base=authorization.authorization,
            is_container="container",
            yang_name="authorization",
            parent=self,
            path_helper=self._path_helper,
            extmethods=self._extmethods,
            register_paths=True,
        ...
        self.__server_groups = YANGDynClass(
            base=server_groups.server_groups,
            is_container="container",
            yang_name="server-groups",
            parent=self,
            path_helper=self._path_helper,
            extmethods=self._extmethods,
            register_paths=True,
