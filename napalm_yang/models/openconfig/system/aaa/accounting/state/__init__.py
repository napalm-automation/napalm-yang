...
class state(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__accounting_method',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'system', u'aaa', u'accounting', u'state']
...
the local system.
  ...
  _pyangbind_elements = {'accounting_method': accounting_method, }
