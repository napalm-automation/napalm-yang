...
class state(PybindBase):
  ...
  """
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.__password_encrypted = YANGDynClass(
            base=six.text_type,
            is_leaf=True,
            ...
            namespace="http://openconfig.net/yang/system",
            defining_module="openconfig-system",
            yang_type="oc-aaa-types:crypt-password-type",
            is_config=False,
        )
        self.__ssh_key = YANGDynClass(
            base=six.text_type,
            is_leaf=True,
            yang_name="ssh-key",
            parent=self,
            ...
            base=[
                ...
                RestrictedClassType(
                    ...
                    restriction_arg={
                        ...
                        "oc-aaa-types:SYSTEM_ROLE_ADMIN": {
                            "@module": "openconfig-aaa-types",
                            "@namespace": "http://openconfig.net/yang/aaa/types",
                        },
                    },
            ...
            raise ValueError(
                {
                    ...
                    "generated-type": """YANGDynClass(base=six.text_type, is_leaf=True, yang_name="password-encrypted", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/system', defining_module='openconfig-system', yang_type='oc-aaa-types:crypt-password-type', is_config=False)""",
                }
            )
