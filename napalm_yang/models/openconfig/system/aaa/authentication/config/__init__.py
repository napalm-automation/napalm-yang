...
class config(PybindBase):
  ...
  """
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.__authentication_method = YANGDynClass(
            base=TypedListType(
                allowed_type=[
                    RestrictedClassType(
            ...
            is_leaf=False,
            yang_name="authentication-method",
            parent=self,
...
user being denied access.
    ...
    authentication_method = __builtin__.property(
        _get_authentication_method, _set_authentication_method
    )
