...
class authentication(PybindBase):
  ...
  """
    __slots__ = (
        "_path_helper", "_extmethods", "__config", "__state", "__admin_user", "__users"
    )
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.__admin_user = YANGDynClass(
            base=admin_user.admin_user,
            is_container="container",
            yang_name="admin-user",
            parent=self,
            path_helper=self._path_helper,
            extmethods=self._extmethods,
            register_paths=True,
