...
class authentication(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__config','__state','__admin_user','__users',)
...
configuration and operational state
  ...
  _pyangbind_elements = {'config': config, 'state': state, 'admin_user': admin_user, 'users': users, }
