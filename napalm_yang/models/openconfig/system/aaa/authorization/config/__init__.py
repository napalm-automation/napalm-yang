...
methods
  """
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.__authorization_method = YANGDynClass(
            base=TypedListType(
                allowed_type=[
                    RestrictedClassType(
            ...
            is_leaf=False,
            yang_name="authorization-method",
            parent=self,
...
that the named server group exists.
    ...
    authorization_method = __builtin__.property(
        _get_authorization_method, _set_authorization_method
    )
