...
to authorization
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__event',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'system', u'aaa', u'authorization', u'events']
  ...
  _pyangbind_elements = {'event': event, }
