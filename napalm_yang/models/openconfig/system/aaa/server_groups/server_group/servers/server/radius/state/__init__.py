...
class state(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__auth_port','__acct_port','__secret_key','__source_address','__retransmit_attempts',)
...
RADIUS server when it is unresponsive
  ...
  _pyangbind_elements = {'auth_port': auth_port, 'acct_port': acct_port, 'secret_key': secret_key, 'source_address': source_address, 'retransmit_attempts': retransmit_attempts, }
