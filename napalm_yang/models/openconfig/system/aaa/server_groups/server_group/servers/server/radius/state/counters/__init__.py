...
class counters(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__retried_access_requests','__access_accepts','__access_rejects','__timeout_access_requests',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'system', u'aaa', u'server-groups', u'server-group', u'servers', u'server', u'radius', u'state', u'counters']
...
requiring retransmission.
  ...
  _pyangbind_elements = {'retried_access_requests': retried_access_requests, 'access_accepts': access_accepts, 'access_rejects': access_rejects, 'timeout_access_requests': timeout_access_requests, }
