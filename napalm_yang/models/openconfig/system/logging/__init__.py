...
class logging(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__console','__remote_servers',)
...
logging
  ...
  _pyangbind_elements = {'console': console, 'remote_servers': remote_servers, }
