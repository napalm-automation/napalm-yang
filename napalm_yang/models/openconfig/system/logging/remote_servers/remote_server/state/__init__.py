...
class state(PybindBase):
  ...
  def _get_host(self):
    """
    Getter method for host, mapped from YANG variable /system/logging/remote_servers/remote_server/state/host (inet:host)
  ...
  def _set_host(self, v, load=False):
    """
    Setter method for host, mapped from YANG variable /system/logging/remote_servers/remote_server/state/host (inet:host)
  ...
  def _get_source_address(self):
    """
    Getter method for source_address, mapped from YANG variable /system/logging/remote_servers/remote_server/state/source_address (inet:ip-address)
  ...
  def _set_source_address(self, v, load=False):
    """
    Setter method for source_address, mapped from YANG variable /system/logging/remote_servers/remote_server/state/source_address (inet:ip-address)
    If this variable is read-only (config: false) in the
  ...
  def _get_remote_port(self):
    """
    Getter method for remote_port, mapped from YANG variable /system/logging/remote_servers/remote_server/state/remote_port (inet:port-number)
...
the server.  The default for syslog is 514.
  ...
  def _set_remote_port(self, v, load=False):
    """
    Setter method for remote_port, mapped from YANG variable /system/logging/remote_servers/remote_server/state/remote_port (inet:port-number)
    If this variable is read-only (config: false) in the
