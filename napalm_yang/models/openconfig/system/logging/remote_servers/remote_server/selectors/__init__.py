...
class selectors(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__selector',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'system', u'logging', u'remote-servers', u'remote-server', u'selectors']
  ...
  _pyangbind_elements = {'selector': selector, }
