...
class component(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__name','__config','__state','__properties','__subcomponents','__linecard','__breakout_mode','__transceiver',)
  ...
  def _get_breakout_mode(self):
    """
    Getter method for breakout_mode, mapped from YANG variable /components/component/breakout_mode (container)
  ...
  def _set_breakout_mode(self, v, load=False):
    """
    Setter method for breakout_mode, mapped from YANG variable /components/component/breakout_mode (container)
    If this variable is read-only (config: false) in the
  ...
  _pyangbind_elements = {'name': name, 'config': config, 'state': state, 'properties': properties, 'subcomponents': subcomponents, 'linecard': linecard, 'breakout_mode': breakout_mode, 'transceiver': transceiver, }
