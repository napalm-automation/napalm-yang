...
class state(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__ethernet_pmd = None
    self.__vendor = None
    self.__fault_condition = None
    self.__otn_compliance_code = None
    self.__ethernet_pmd_preconf = None
    self.__enabled = None
    self.__internal_temp = None
    self.__date_code = None
    self.__connector_type = None
    self.__sonet_sdh_compliance_code = None
    self.__vendor_rev = None
    self.__form_factor = None
    self.__vendor_part = None
    self.__form_factor_preconf = None
    self.__present = None
...
powered off
  ...
  def _initialized_form_factor_preconf(self):
    return self.__form_factor_preconf is not None
...
the system.
    """
    if self.__form_factor_preconf is None:
...
the system.
  ...
  def _initialized_ethernet_pmd_preconf(self):
    return self.__ethernet_pmd_preconf is not None
...
indicated by the ethernet-pmd state leaf.
    """
    if self.__ethernet_pmd_preconf is None:
...
indicated by the ethernet-pmd state leaf.
  ...
  def _initialized_present(self):
    return self.__present is not None
...
the specified client port.
  ...
  def _initialized_form_factor(self):
    return self.__form_factor is not None
...
(QSFP28, for example).
  ...
  def _initialized_connector_type(self):
    return self.__connector_type is not None
  ...
  def _get_connector_type(self):
    ...
    """
    if self.__connector_type is None:
  ...
  def _initialized_internal_temp(self):
    return self.__internal_temp is not None
...
better than +/- 3 degC over the whole temperature range.
    """
    if self.__internal_temp is None:
...
right with ASCII spaces (20h)
  ...
  def _initialized_vendor_part(self):
    return self.__vendor_part is not None
...
all 16 octets = 0h
  ...
  def _initialized_vendor_rev(self):
    return self.__vendor_rev is not None
...
right with ASCII spaces (20h)
  ...
  def _initialized_ethernet_pmd(self):
    return self.__ethernet_pmd is not None
...
this and CFP MSA has similar.
    """
    if self.__ethernet_pmd is None:
...
this and CFP MSA has similar.
  ...
  def _initialized_sonet_sdh_compliance_code(self):
    return self.__sonet_sdh_compliance_code is not None
  ...
  def _get_sonet_sdh_compliance_code(self):
    ...
    """
    if self.__sonet_sdh_compliance_code is None:
  ...
  def _initialized_otn_compliance_code(self):
    return self.__otn_compliance_code is not None
  ...
  def _get_otn_compliance_code(self):
    ...
    """
    if self.__otn_compliance_code is None:
...
16 octets = 0h
  ...
  def _initialized_date_code(self):
    return self.__date_code is not None
...
undefined and not intended to be read.
  ...
  def _initialized_fault_condition(self):
    return self.__fault_condition is not None
  ...
  def _get_fault_condition(self):
    ...
    """
    if self.__fault_condition is None:
