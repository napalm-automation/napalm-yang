...
class transceiver(PybindBase):
  ...
  """
    __slots__ = (
        "_path_helper", "_extmethods", "__config", "__state", "__physical_channels"
    )
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.__physical_channels = YANGDynClass(
            base=physical_channels.physical_channels,
            is_container="container",
            yang_name="physical-channels",
            parent=self,
            path_helper=self._path_helper,
            extmethods=self._extmethods,
            register_paths=True,
    ...
    physical_channels = __builtin__.property(
        _get_physical_channels, _set_physical_channels
    )

    _pyangbind_elements = OrderedDict(
        [("config", config), ("state", state), ("physical_channels", physical_channels)]
    )
