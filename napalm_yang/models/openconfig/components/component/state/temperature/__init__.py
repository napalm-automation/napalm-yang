...
to just supply the instant value
  """
    __slots__ = (
        "_path_helper", "_extmethods", "__instant", "__avg", "__min_", "__max_"
    )
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.__instant = YANGDynClass(
            base=RestrictedPrecisionDecimalType(precision=1),
            is_leaf=True,
            yang_name="instant",
            parent=self,
...
period
    ...
    _pyangbind_elements = OrderedDict(
        [("instant", instant), ("avg", avg), ("min_", min_), ("max_", max_)]
    )
