...
class config(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__power',)
  ...
  def _get_power(self):
    """
    Getter method for power, mapped from YANG variable /components/component/linecard/config/power (oc-platform-types:component-power-type)
  ...
  def _set_power(self, v, load=False):
    """
    Setter method for power, mapped from YANG variable /components/component/linecard/config/power (oc-platform-types:component-power-type)
  ...
  _pyangbind_elements = {'power': power, }
