...
class state(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__power_admin_state','__slot_id',)
...
linecard is installed
  ...
  _pyangbind_elements = {'power_admin_state': power_admin_state, 'slot_id': slot_id, }
