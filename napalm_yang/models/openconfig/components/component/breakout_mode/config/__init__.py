...
class config(PybindBase):
  ...
  from YANG module openconfig-platform - based on the path /components/component/breakout-mode/config. Each member element of
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'components', u'component', u'breakout-mode', u'config']

  def _get_num_channels(self):
    """
    Getter method for num_channels, mapped from YANG variable /components/component/breakout_mode/config/num_channels (uint8)
...
capable of channelization
  ...
  def _set_num_channels(self, v, load=False):
    """
    Setter method for num_channels, mapped from YANG variable /components/component/breakout_mode/config/num_channels (uint8)
...
capable of channelization
  ...
  def _get_channel_speed(self):
    """
    Getter method for channel_speed, mapped from YANG variable /components/component/breakout_mode/config/channel_speed (identityref)
...
ETHERNET_SPEED identity
  ...
  def _set_channel_speed(self, v, load=False):
    """
    Setter method for channel_speed, mapped from YANG variable /components/component/breakout_mode/config/channel_speed (identityref)
    If this variable is read-only (config: false) in the
