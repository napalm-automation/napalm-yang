...
class state(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__enabled','__mtu','__dhcp_client','__counters',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interfaces', u'interface', u'tunnel', u'ipv4', u'state']
...
reception for the address family.
  ...
  _pyangbind_elements = {'enabled': enabled, 'mtu': mtu, 'dhcp_client': dhcp_client, 'counters': counters, }
