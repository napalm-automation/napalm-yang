...
interface
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__is_router = YANGDynClass(base=YANGBool, is_leaf=True, yang_name="is-router", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/interfaces/tunnel', defining_module='openconfig-if-tunnel', yang_type='empty', is_config=False)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interfaces', u'interface', u'tunnel', u'ipv6', u'neighbors', u'neighbor', u'state']
  ...
  def _get_is_router(self):
    """
    Getter method for is_router, mapped from YANG variable /interfaces/interface/tunnel/ipv6/neighbors/neighbor/state/is_router (empty)
  ...
  def _set_is_router(self, v, load=False):
    """
    Setter method for is_router, mapped from YANG variable /interfaces/interface/tunnel/ipv6/neighbors/neighbor/state/is_router (empty)
    If this variable is read-only (config: false) in the
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=YANGBool, is_leaf=True, yang_name="is-router", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/interfaces/tunnel', defining_module='openconfig-if-tunnel', yang_type='empty', is_config=False)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """is_router must be of a type compatible with empty""",
          'defined-type': "empty",
          'generated-type': """YANGDynClass(base=YANGBool, is_leaf=True, yang_name="is-router", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/interfaces/tunnel', defining_module='openconfig-if-tunnel', yang_type='empty', is_config=False)""",
        })
