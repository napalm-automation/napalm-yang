...
failure
    ...
    _pyangbind_elements = OrderedDict(
        [
            ("in_mac_control_frames", in_mac_control_frames),
            ("in_mac_pause_frames", in_mac_pause_frames),
            ("in_oversize_frames", in_oversize_frames),
            ("in_jabber_frames", in_jabber_frames),
            ("in_fragment_frames", in_fragment_frames),
            ("in_8021q_frames", in_8021q_frames),
            ("in_crc_errors", in_crc_errors),
            ("out_mac_control_frames", out_mac_control_frames),
            ("out_mac_pause_frames", out_mac_pause_frames),
            ("out_8021q_frames", out_8021q_frames),
        ]
    )
