...
class state(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__enabled','__power_used','__power_class',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interfaces', u'interface', u'ethernet', u'poe', u'state']
...
interface.
  ...
  _pyangbind_elements = {'enabled': enabled, 'power_used': power_used, 'power_class': power_class, }
