...
and state
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__config','__state','__switched_vlan','__poe',)
...
L2, switched-style VLANs.
  ...
  _pyangbind_elements = {'config': config, 'state': state, 'switched_vlan': switched_vlan, 'poe': poe, }
