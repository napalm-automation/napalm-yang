...
and state
  """
    __slots__ = (
        "_path_helper", "_extmethods", "__config", "__state", "__switched_vlan"
    )
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.__switched_vlan = YANGDynClass(
            base=switched_vlan.switched_vlan,
            is_container="container",
            yang_name="switched-vlan",
            parent=self,
            path_helper=self._path_helper,
            extmethods=self._extmethods,
            register_paths=True,
...
L2, switched-style VLANs.
    ...
    _pyangbind_elements = OrderedDict(
        [("config", config), ("state", state), ("switched_vlan", switched_vlan)]
    )
