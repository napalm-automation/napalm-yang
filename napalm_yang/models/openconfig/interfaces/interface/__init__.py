...
class interface(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__name','__config','__state','__hold_time','__subinterfaces','__ethernet','__aggregation','__routed_vlan','__tunnel',)
...
with them.
  ...
  _pyangbind_elements = {'name': name, 'config': config, 'state': state, 'hold_time': hold_time, 'subinterfaces': subinterfaces, 'ethernet': ethernet, 'aggregation': aggregation, 'routed_vlan': routed_vlan, 'tunnel': tunnel, }
