...
class state(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__track_interface = YANGDynClass(base=TypedListType(allowed_type=unicode), is_leaf=False, yang_name="track-interface", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/interfaces/ip', defining_module='openconfig-if-ip', yang_type='leafref', is_config=False)
