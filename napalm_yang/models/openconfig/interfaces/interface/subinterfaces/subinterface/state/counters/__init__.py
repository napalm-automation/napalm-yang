...
class counters(PybindBase):
  ...
  """
  __slots__ = ('_path_helper', '_extmethods', '__in_octets','__in_unicast_pkts','__in_broadcast_pkts','__in_multicast_pkts','__in_discards','__in_errors','__in_unknown_protos','__out_octets','__out_unicast_pkts','__out_broadcast_pkts','__out_multicast_pkts','__out_discards','__out_errors','__last_clear',)
