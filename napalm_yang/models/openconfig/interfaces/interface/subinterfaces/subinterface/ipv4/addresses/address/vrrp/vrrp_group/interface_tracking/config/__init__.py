            ...
            raise ValueError(
                {
                    ...
                    "generated-type": """YANGDynClass(base=six.text_type, is_leaf=True, yang_name="track-interface", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://openconfig.net/yang/interfaces/ip', defining_module='openconfig-if-ip', yang_type='leafref', is_config=True)""",
                }
            )
...
the tracked interface goes down
    ...
    priority_decrement = __builtin__.property(
        _get_priority_decrement, _set_priority_decrement
    )
