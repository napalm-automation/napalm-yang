...
preferred.
    ...
    create_global_addresses = __builtin__.property(
        _get_create_global_addresses, _set_create_global_addresses
    )
    create_temporary_addresses = __builtin__.property(
        _get_create_temporary_addresses, _set_create_temporary_addresses
    )
    temporary_valid_lifetime = __builtin__.property(
        _get_temporary_valid_lifetime, _set_temporary_valid_lifetime
    )
    temporary_preferred_lifetime = __builtin__.property(
        _get_temporary_preferred_lifetime, _set_temporary_preferred_lifetime
    )
