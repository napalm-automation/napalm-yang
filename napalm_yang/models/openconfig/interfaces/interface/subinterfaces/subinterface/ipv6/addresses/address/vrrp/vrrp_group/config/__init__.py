...
address
    ...
    virtual_router_id = __builtin__.property(
        _get_virtual_router_id, _set_virtual_router_id
    )
    ...
    advertisement_interval = __builtin__.property(
        _get_advertisement_interval, _set_advertisement_interval
    )
    virtual_link_local = __builtin__.property(
        _get_virtual_link_local, _set_virtual_link_local
    )
    ...
    _pyangbind_elements = OrderedDict(
        [
            ...
            ("virtual_link_local", virtual_link_local),
        ]
    )
