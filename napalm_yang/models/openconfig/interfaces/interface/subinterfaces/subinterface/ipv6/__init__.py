...
class ipv6(PybindBase):
  ...
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__addresses','__router_advertisement','__neighbors','__unnumbered','__config','__state','__autoconf',)
...
address information
  ...
  _pyangbind_elements = {'addresses': addresses, 'router_advertisement': router_advertisement, 'neighbors': neighbors, 'unnumbered': unnumbered, 'config': config, 'state': state, 'autoconf': autoconf, }
