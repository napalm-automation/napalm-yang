...
class ipv6(PybindBase):
  ...
  """
  __slots__ = ('_path_helper', '_extmethods', '__addresses','__neighbors','__unnumbered','__config','__state','__autoconf',)
...
address information
  ...
  _pyangbind_elements = OrderedDict([('addresses', addresses), ('neighbors', neighbors), ('unnumbered', unnumbered), ('config', config), ('state', state), ('autoconf', autoconf), ])
