...
for IPv6.
  """
  __slots__ = ('_pybind_generated_by', '_path_helper', '_yang_name', '_extmethods', '__interval','__lifetime','__suppress',)
  ...
  def _path(self):
    if hasattr(self, "_parent"):
      ...
      return [u'interfaces', u'interface', u'subinterfaces', u'subinterface', u'ipv6', u'router-advertisement', u'config']
...
messages are not transmitted on this interface.
  ...
  _pyangbind_elements = {'interval': interval, 'lifetime': lifetime, 'suppress': suppress, }
