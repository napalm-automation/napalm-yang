...
aggregate / LAG interfaces
  """
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.__lag_type = YANGDynClass(
            base=RestrictedClassType(
                base_type=six.text_type,
                restriction_type="dict_key",
                restriction_arg={"LACP": {}, "STATIC": {}},
            ),
            is_leaf=True,
            yang_name="lag-type",
            parent=self,
            ...
            yang_type="aggregation-type",
            is_config=False,
        )
        self.__min_links = YANGDynClass(
            base=RestrictedClassType(
        ...
        self.__member = YANGDynClass(
            ...
            namespace="http://openconfig.net/yang/interfaces/aggregate",
            defining_module="openconfig-if-aggregate",
            yang_type="oc-if:base-interface-ref",
            is_config=False,
        )
